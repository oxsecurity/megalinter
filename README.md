...
| <!-- --> <!-- linter-icon --> |  | [markdown-table-prettify](https://github.com/nvuillam/mega-linter/tree/master/docs/descriptors/markdown_markdown_table_prettify.md#readme)| [MARKDOWN_MARKDOWN_TABLE_PRETTIFY](https://github.com/nvuillam/mega-linter/tree/master/docs/descriptors/markdown_markdown_table_prettify.md#readme)| :heavy_check_mark: |
