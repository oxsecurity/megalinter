...
[![](https://img.shields.io/static/v1?label=Used%20by&message=2256&color=informational&logo=slickpic)](https://github.com/oxsecurity/megalinter/network/dependents)<!-- gh-dependents-info-used-by-end -->
...
| **SECURED_ENV_VARIABLES**                                  | `GITHUB_TOKEN,PAT`                       | List of secured environment variables to hide when calling pre_commands and linters                                                                                                                        |
