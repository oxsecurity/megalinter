...
| <img src="https://github.com/megalinter/megalinter/raw/main/docs/assets/icons/default.ico" alt="" height="32px" class="megalinter-icon"></a> <!-- linter-icon -->  | [**NIX**](https://github.com/megalinter/megalinter/tree/main/docs/descriptors/nix.md#readme)           | [nixpkgs-fmt](https://github.com/megalinter/megalinter/tree/main/docs/descriptors/nix_nixpkgs_fmt.md#readme)                                | [NIX_NIXPKGS_FMT](https://github.com/megalinter/megalinter/tree/main/docs/descriptors/nix_nixpkgs_fmt.md#readme)                                     | :heavy_check_mark: |
