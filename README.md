...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by&message=5347&color=informational&logo=slickpic)](https://github.com/oxsecurity/megalinter/blob/main/./docs/used-by-stats.md)<!-- gh-dependents-info-used-by-end -->
...
Supports [**68** languages](#languages), [**23** formats](#formats), [**21** tooling formats](#tooling-formats), and is **ready to use out of the box** as a GitHub Action or with any CI system. It is **highly configurable** and **free for all uses**.
