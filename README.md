...
[![Docker Pulls](https://img.shields.io/badge/docker%20pulls-3.8M-blue)](https://megalinter.github.io/flavors/)
...
[![](https://img.shields.io/static/v1?label=Used%20by&message=1884&color=informational&logo=slickpic)](https://github.com/oxsecurity/megalinter/network/dependents)<!-- gh-dependents-info-used-by-end -->
...
Supporting [**52** languages](#languages), [**24** formats](#formats), [**21** tooling formats](#tooling-formats) and **ready to use out of the box**, as a GitHub action or any CI system **highly configurable** and **free for all uses**.
...
| <!-- --> <!-- linter-icon --> |  | [rstfmt](https://github.com/oxsecurity/megalinter/tree/main/docs/descriptors/rst_rstfmt.md#readme)| [RST_RSTFMT](https://github.com/oxsecurity/megalinter/tree/main/docs/descriptors/rst_rstfmt.md#readme)| ![formatter](https://shields.io/badge/-format-yellow) |
