...
class DashboardBuilderDatadog(DashboardBuilder):
    ...
    def query_value(self, title, query, precision=0):
        return {
            "definition": {
                "title": title,
                "type": "query_value",
    ...
    def timeseries(self, title, query, display_type="line", links=None):
        definition = {
            "title": title,
            "type": "timeseries",
            "requests": [
    ...
    def toplist_metrics(self, title, query, links=None):
        definition = {
            "title": title,
            "type": "toplist",
            "requests": [
