...
runs:
  using: "docker"
  image: "docker://nvuillam/mega-linter:{image_release}"
  args:
    - "-v"
    ...
    for linter in descriptor_linters:
        ...
        if linter.cli_lint_mode != "project":
            linter_doc_md += [
                ...
                f"- `file`: Calls the linter for each file<br/>- `list_of_files`: Call the linter with the list of files as argument<br/>- `project`: Call the linter from the root of the project | {linter.cli_lint_mode} |"
            ]
            add_in_config_schema_file(
                [
                    [
