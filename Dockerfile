...
ARG NPM_SECRETLINT_VERSION=10.0.0
# renovate: datasource=npm depName=@secretlint/secretlint-rule-preset-recommend
ARG NPM_SECRETLINT_SECRETLINT_RULE_PRESET_RECOMMEND_VERSION=10.0.0
# renovate: datasource=npm depName=@secretlint/secretlint-formatter-sarif
ARG NPM_SECRETLINT_SECRETLINT_FORMATTER_SARIF_VERSION=10.0.0
# renovate: datasource=pypi depName=semgrep
ARG PIP_SEMGREP_VERSION=1.125.0
