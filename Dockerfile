...
ARG REPOSITORY_TRUFFLEHOG_VERSION=3.88.28
...
ARG SFDX_HARDIS_VERSION=5.31.0
...
ARG NPM_ESLINT_PLUGIN_N_VERSION=17.18.0
...
ARG LIGHTNING_FLOW_SCANNER_VERSION=3.12.0
...
ARG NPM_TYPESCRIPT_ESLINT_ESLINT_PLUGIN_VERSION=8.32.0
# renovate: datasource=npm depName=@typescript-eslint/parser
ARG NPM_TYPESCRIPT_ESLINT_PARSER_VERSION=8.32.0
