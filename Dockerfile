...
ARG NPM_GROOVY_LINT_VERSION=17.0.3
...
ARG NPM_ESLINT_PLUGIN_JEST_VERSION=29.15.1
...
ARG NPM_PRETTIER_VERSION=3.8.2
...
ARG PHP_PHPSTAN_PHPSTAN_VERSION=2.1.49
...
ARG NPM_SECRETLINT_VERSION=11.4.1
# renovate: datasource=npm depName=@secretlint/secretlint-rule-preset-recommend
ARG NPM_SECRETLINT_SECRETLINT_RULE_PRESET_RECOMMEND_VERSION=11.4.1
# renovate: datasource=npm depName=@secretlint/secretlint-formatter-sarif
ARG NPM_SECRETLINT_SECRETLINT_FORMATTER_SARIF_VERSION=11.4.1
