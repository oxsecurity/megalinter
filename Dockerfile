...
# PHP installation
RUN apk add --no-cache --repository http://dl-cdn.alpinelinux.org/alpine/v3.15/main php7 php7-phar php7-json php7-mbstring php7-xmlwriter php7-tokenizer php7-ctype php7-curl php7-dom php7-simplexml
