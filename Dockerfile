...
ARG SFDX_HARDIS_VERSION=6.26.2
# renovate: datasource=npm depName=typescript
ARG NPM_TYPESCRIPT_VERSION=5.9.3
# renovate: datasource=pypi depName=ansible-lint
ARG PIP_ANSIBLE_LINT_VERSION=26.2.0
...
ARG PIP_CFN_LINT_VERSION=1.45.0
...
ARG GO_GOLANGCI_LINT_VERSION=2.10.1
...
ARG GEM_RUBOCOP_VERSION=1.85.0
...
RUN uv pip install --system --no-cache pip==${PIP_PIP_VERSION} virtualenv==${PIP_VIRTUALENV_VERSION} \
    ...
    && VIRTUAL_ENV="/venvs/ansible-lint" rm -rf /venvs/ansible-lint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/cpplint" rm -rf /venvs/cpplint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/cfn-lint" rm -rf /venvs/cfn-lint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/stylelint" rm -rf /venvs/stylelint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/djlint" rm -rf /venvs/djlint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/rumdl" rm -rf /venvs/rumdl/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/pylint" rm -rf /venvs/pylint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/black" rm -rf /venvs/black/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/flake8" rm -rf /venvs/flake8/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/isort" rm -rf /venvs/isort/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/bandit" rm -rf /venvs/bandit/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/mypy" rm -rf /venvs/mypy/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/nbqa" rm -rf /venvs/nbqa/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/ruff" rm -rf /venvs/ruff/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/ruff-format" rm -rf /venvs/ruff-format/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/checkov" rm -rf /venvs/checkov/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/semgrep" rm -rf /venvs/semgrep/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/robocop" rm -rf /venvs/robocop/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/rst-lint" rm -rf /venvs/rst-lint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/rstcheck" rm -rf /venvs/rstcheck/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/rstfmt" rm -rf /venvs/rstfmt/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/snakemake" rm -rf /venvs/snakemake/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/snakefmt" rm -rf /venvs/snakefmt/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/proselint" rm -rf /venvs/proselint/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/codespell" rm -rf /venvs/codespell/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/sqlfluff" rm -rf /venvs/sqlfluff/lib/python3.14/site-packages/setuptools/_vendor/wheel* \
    ...
    && VIRTUAL_ENV="/venvs/yamllint" rm -rf /venvs/yamllint/lib/python3.14/site-packages/setuptools/_vendor/wheel*  \
