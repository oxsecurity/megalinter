...
#############################################################################################
#FROM__START
FROM golang:${GO_VERSION} AS go-lang
...
#COPY__START
COPY --link --from=go-lang /usr/local/go /usr/local/go
...
#
# GO installation
# Managed with COPY --link --from=go-lang /usr/local/go /usr/local/go
#
# JAVA installation
