...
ARG SFDX_HARDIS_VERSION=7.22.0
...
ARG PIP_CFN_LINT_VERSION=1.53.1
...
ARG NPM_ESLINT_REACT_ESLINT_PLUGIN_VERSION=5.17.1
...
ARG REPOSITORY_SYFT_VERSION=1.48.0
...
ARG REPOSITORY_KINGFISHER_VERSION=1.108.0
...
ARG NPM_TYPESCRIPT_ESLINT_ESLINT_PLUGIN_VERSION=8.64.0
# renovate: datasource=npm depName=@typescript-eslint/parser
ARG NPM_TYPESCRIPT_ESLINT_PARSER_VERSION=8.64.0
