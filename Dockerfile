...
ARG PROTOBUF_PROTOLINT_VERSION=0.56.3
...
ARG PIP_ANSIBLE_LINT_VERSION=25.8.2
...
ARG PIP_CFN_LINT_VERSION=1.39.0
...
ARG NPM_BABEL_CORE_VERSION=7.28.3
...
ARG PHP_FRIENDSOFPHP_PHP_CS_FIXER_VERSION=v3.86.0
...
ARG NPM_SECRETLINT_VERSION=11.2.0
# renovate: datasource=npm depName=@secretlint/secretlint-rule-preset-recommend
ARG NPM_SECRETLINT_SECRETLINT_RULE_PRESET_RECOMMEND_VERSION=11.2.0
# renovate: datasource=npm depName=@secretlint/secretlint-formatter-sarif
ARG NPM_SECRETLINT_SECRETLINT_FORMATTER_SARIF_VERSION=11.2.0
...
# renovate: datasource=github-tags depName=aquasecurity/trivy
ARG REPOSITORY_TRIVY_SBOM_VERSION=0.65.0
...
ARG GEM_RUBOCOP_VERSION=1.80.0
...
ARG NPM_TYPESCRIPT_ESLINT_ESLINT_PLUGIN_VERSION=8.39.1
# renovate: datasource=npm depName=@typescript-eslint/parser
ARG NPM_TYPESCRIPT_ESLINT_PARSER_VERSION=8.39.1
