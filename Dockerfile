...
ARG NPM_ESLINT_PLUGIN_JEST_VERSION=29.11.1
...
ARG RUMDL_MYPY_VERSION=0.0.208
...
ARG REPOSITORY_SYFT_VERSION=1.39.0
...
ARG NPM_TYPESCRIPT_ESLINT_ESLINT_PLUGIN_VERSION=8.51.0
# renovate: datasource=npm depName=@typescript-eslint/parser
ARG NPM_TYPESCRIPT_ESLINT_PARSER_VERSION=8.51.0
