...
| `--container-engine`             | Allows to specify a container engine (`docker`, `podman`, or `container`)                                                                                                                                                                                                                                                                                                                                                                                                                                           | `docker`          |
...
```shell
# Use Apple's native container engine on macOS (Apple Silicon only)
mega-linter-runner --flavor documentation --container-engine container --platform linux/arm64
```
