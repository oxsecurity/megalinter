...
| **ENABLE_SUGGESTIONS**                              | `true`                       | Provides suggestions about configuration and different Mega-Linter flavors to use to improve runtime performance and completeness                                                                           |
