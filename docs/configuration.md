...
| **DEFAULT_BRANCH**                                  | `main`                       | The name of the repository's default branch. Warning: In new github repositories, main branch is named `main`, so you need to override this value with `main`                                              |
