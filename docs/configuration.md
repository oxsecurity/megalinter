...
You can see an example config file in this repo: [**.mega-linter.yml**](https://github.com/mega-linter/mega-linter/blob/master/.mega-linter.yml)

Configuration is assisted with auto-completion and validation in most commonly used IDEs, thanks to [JSON schema](https://mega-linter.github.io/json-schemas/configuration.html) stored on [schemastore.org](https://www.schemastore.org/)
...
![Assisted configuration](https://github.com/mega-linter/mega-linter/raw/master/docs/assets/images/assisted-configuration.jpg)
