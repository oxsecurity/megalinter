...
| **FORWARD_EXCLUDED_DIRECTORIES**                                     | `true`                                        | In project CLI lint mode, forward excluded directories to the linters through their native exclusion arguments or generated ignore/config files. Override per-linter with \*_FORWARD_EXCLUDED_DIRECTORIES  |
