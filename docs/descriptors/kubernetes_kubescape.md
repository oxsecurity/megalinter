...
| KUBERNETES_KUBESCAPE_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling KUBERNETES_KUBESCAPE and its pre/post commands                                                                                 | None                         |
