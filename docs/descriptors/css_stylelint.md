...
- Enable stylelint by adding `CSS_STYLELINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.1/configuration/#activation-and-deactivation)
- Disable stylelint by adding `CSS_STYLELINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.1/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `CSS_STYLELINT` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.9.1/configuration/#apply-fixes)
