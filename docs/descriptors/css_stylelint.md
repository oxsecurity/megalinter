...
- Enable stylelint by adding `CSS_STYLELINT` in [ENABLE_LINTERS variable](https://megalinter.io/8.3.1/configuration/#activation-and-deactivation)
- Disable stylelint by adding `CSS_STYLELINT` in [DISABLE_LINTERS variable](https://megalinter.io/8.3.1/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `CSS_STYLELINT` in [APPLY_FIXES variable](https://megalinter.io/8.3.1/configuration/#apply-fixes)
