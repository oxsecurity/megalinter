...
| C_CPPCHECK_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with C_CPPCHECK_CLI_LINT_MODE = project 
| C_CPPCHECK_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with C_CPPCHECK_CLI_LINT_MODE = project 
