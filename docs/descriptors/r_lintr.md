...
- Enable lintr by adding `R_LINTR` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.0/configuration/#activation-and-deactivation)
- Disable lintr by adding `R_LINTR` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.0/configuration/#activation-and-deactivation)
