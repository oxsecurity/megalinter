...
- Enable lintr by adding `R_LINTR` in [ENABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
- Disable lintr by adding `R_LINTR` in [DISABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
