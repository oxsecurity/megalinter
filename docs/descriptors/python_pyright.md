...
<div align="center">
  <a href="https://google.github.io/pytype/" target="blank" title="Visit linter Web Site">
...
- Enable pyright by adding `PYTHON_PYRIGHT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.0/configuration/#activation-and-deactivation)
- Disable pyright by adding `PYTHON_PYRIGHT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.0/configuration/#activation-and-deactivation)
