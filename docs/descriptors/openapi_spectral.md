...
| OPENAPI_SPECTRAL_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling OPENAPI_SPECTRAL and its pre/post commands                                                                                     | None                                            |
