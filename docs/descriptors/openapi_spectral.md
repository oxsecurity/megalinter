...
- Enable spectral by adding `OPENAPI_SPECTRAL` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#activation-and-deactivation)
- Disable spectral by adding `OPENAPI_SPECTRAL` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#activation-and-deactivation)
