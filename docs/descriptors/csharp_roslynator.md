...
- Enable roslynator by adding `CSHARP_ROSLYNATOR` in [ENABLE_LINTERS variable](https://megalinter.io/7.8.0/configuration/#activation-and-deactivation)
- Disable roslynator by adding `CSHARP_ROSLYNATOR` in [DISABLE_LINTERS variable](https://megalinter.io/7.8.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `CSHARP_ROSLYNATOR` in [APPLY_FIXES variable](https://megalinter.io/7.8.0/configuration/#apply-fixes)
...
```shell
Roslynator Command Line Tool version 0.8.2.0 (Roslyn version 4.8.0.0)
