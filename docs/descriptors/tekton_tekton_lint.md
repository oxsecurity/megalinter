...
| TEKTON_TEKTON_LINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling TEKTON_TEKTON_LINT and its pre/post commands                                                                                   | None                                            |
