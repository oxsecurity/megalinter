...
| JSON_NPM_PACKAGE_JSON_LINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling JSON_NPM_PACKAGE_JSON_LINT and its pre/post commands                                                                           | None                                            |
