...
# <a href="https://npmpackagejsonlint.org/" target="blank" title="Visit linter Web Site"><img src="https://npmpackagejsonlint.org/img/logo.svg" alt="npm-package-json-lint" height="100px" class="megalinter-logo"></a>npm-package-json-lint [![GitHub last commit](https://img.shields.io/github/last-commit/tclindner/npm-package-json-lint)](https://github.com/tclindner/npm-package-json-lint/commits)
...
- Enable npm-package-json-lint by adding `JSON_NPM_PACKAGE_JSON_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.17.0/configuration/#activation-and-deactivation)
- Disable npm-package-json-lint by adding `JSON_NPM_PACKAGE_JSON_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.17.0/configuration/#activation-and-deactivation)
