...
- Enable npm-package-json-lint by adding `JSON_NPM_PACKAGE_JSON_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.22.2/configuration/#activation-and-deactivation)
- Disable npm-package-json-lint by adding `JSON_NPM_PACKAGE_JSON_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.22.2/configuration/#activation-and-deactivation)
