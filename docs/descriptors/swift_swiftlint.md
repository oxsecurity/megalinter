...
- Enable swiftlint by adding `SWIFT_SWIFTLINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.15.0/configuration/#activation-and-deactivation)
- Disable swiftlint by adding `SWIFT_SWIFTLINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.15.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `SWIFT_SWIFTLINT` in [APPLY_FIXES variable](https://megalinter.io/6.15.0/configuration/#apply-fixes)
