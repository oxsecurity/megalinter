...
- Enable swiftlint by adding `SWIFT_SWIFTLINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.5.0/configuration/#activation-and-deactivation)
- Disable swiftlint by adding `SWIFT_SWIFTLINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `SWIFT_SWIFTLINT` in [APPLY_FIXES variable](https://megalinter.io/7.5.0/configuration/#apply-fixes)
