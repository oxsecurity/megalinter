...
- APK packages (Linux):
  - [gnupg](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=gnupg)
  - [php84](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84)
  - [php84-phar](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-phar)
  - [php84-mbstring](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-mbstring)
  - [php84-xmlwriter](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-xmlwriter)
  - [php84-tokenizer](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-tokenizer)
  - [php84-ctype](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-ctype)
  - [php84-curl](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-curl)
  - [php84-dom](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-dom)
  - [php84-opcache](https://pkgs.alpinelinux.org/packages?branch=v3.21&arch=x86_64&name=php84-opcache)
