...
- APK packages (Linux):
  - [gnupg](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=gnupg)
  - [php84](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84)
  - [php84-phar](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-phar)
  - [php84-mbstring](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-mbstring)
  - [php84-xmlwriter](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-xmlwriter)
  - [php84-tokenizer](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-tokenizer)
  - [php84-ctype](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-ctype)
  - [php84-curl](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-curl)
  - [php84-dom](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-dom)
  - [php84-opcache](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-opcache)
  - [php84-openssl](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-openssl)
  - [php84-common](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-common)
  - [php84-simplexml](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-simplexml)
  - [php84-iconv](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=php84-iconv)
  - [dpkg](https://pkgs.alpinelinux.org/packages?branch=v3.24&arch=x86_64&name=dpkg)
