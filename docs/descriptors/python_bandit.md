...
- Enable bandit by adding `PYTHON_BANDIT` in [ENABLE_LINTERS variable](https://megalinter.io/8.7.0/configuration/#activation-and-deactivation)
- Disable bandit by adding `PYTHON_BANDIT` in [DISABLE_LINTERS variable](https://megalinter.io/8.7.0/configuration/#activation-and-deactivation)
