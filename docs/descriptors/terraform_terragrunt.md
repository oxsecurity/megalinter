...
- Enable terragrunt by adding `TERRAFORM_TERRAGRUNT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#activation-and-deactivation)
- Disable terragrunt by adding `TERRAFORM_TERRAGRUNT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `TERRAFORM_TERRAGRUNT` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#apply-fixes)
