...
- Enable actionlint by adding `ACTION_ACTIONLINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.0.1/configuration/#activation-and-deactivation)
- Disable actionlint by adding `ACTION_ACTIONLINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.0.1/configuration/#activation-and-deactivation)
