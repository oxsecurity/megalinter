...
- Enable actionlint by adding `ACTION_ACTIONLINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.1/configuration/#activation-and-deactivation)
- Disable actionlint by adding `ACTION_ACTIONLINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.1/configuration/#activation-and-deactivation)
