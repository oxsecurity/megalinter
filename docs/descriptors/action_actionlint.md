...
| ACTION_ACTIONLINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling ACTION_ACTIONLINT and its pre/post commands                                                                                                           | None                                            |
