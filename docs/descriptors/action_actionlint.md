...
- Enable actionlint by adding `ACTION_ACTIONLINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.0.1/configuration/#activation-and-deactivation)
- Disable actionlint by adding `ACTION_ACTIONLINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.0.1/configuration/#activation-and-deactivation)
...
- APK packages (Linux):
  - [py3-pyflakes](https://pkgs.alpinelinux.org/packages?branch=v3.22&arch=x86_64&name=py3-pyflakes)
