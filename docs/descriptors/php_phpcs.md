...
- Enable phpcs by adding `PHP_PHPCS` in [ENABLE_LINTERS variable](https://megalinter.io/8.7.0/configuration/#activation-and-deactivation)
- Disable phpcs by adding `PHP_PHPCS` in [DISABLE_LINTERS variable](https://megalinter.io/8.7.0/configuration/#activation-and-deactivation)
