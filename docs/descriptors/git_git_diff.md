...
- Enable git_diff by adding `GIT_GIT_DIFF` in [ENABLE_LINTERS variable](https://megalinter.io/latest/configuration/#activation-and-deactivation)
- Disable git_diff by adding `GIT_GIT_DIFF` in [DISABLE_LINTERS variable](https://megalinter.io/latest/configuration/#activation-and-deactivation)
...
|      <img src="https://github.com/megalinter/megalinter/raw/main/docs/assets/icons/ci_light.ico" alt="" height="32px" class="megalinter-icon"></a>       | [ci_light](https://megalinter.io/latest/flavors/ci_light/)           | Optimized for CI items (Dockerfile, Jenkinsfile, JSON/YAML schemas,XML |        16        |           ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/megalinter/megalinter-ci_light/v5) ![Docker Pulls](https://img.shields.io/docker/pulls/megalinter/megalinter-ci_light) |
