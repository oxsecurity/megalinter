...
- Enable goodcheck by adding `REPOSITORY_GOODCHECK` in [ENABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
- Disable goodcheck by adding `REPOSITORY_GOODCHECK` in [DISABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
