...
- Enable v8r by adding `JSON_V8R` in [ENABLE_LINTERS variable](https://megalinter.io/9.1.0/configuration/#activation-and-deactivation)
- Disable v8r by adding `JSON_V8R` in [DISABLE_LINTERS variable](https://megalinter.io/9.1.0/configuration/#activation-and-deactivation)
