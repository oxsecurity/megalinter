...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cc', 'hxx', 'cxx', 'cu', 'h', 'h++', 'hh', 'hpp', 'cpp', 'cuh', 'c++', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cc,hxx,cxx,cu,h,h++,hh,hpp,cpp,cuh,c++,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'h++', 'h', 'hh', 'hpp', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hxx,h++,h,hh,hpp,cuh
        --headers=hpp,hxx
        --headers=hpp
