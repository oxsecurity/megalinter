...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'cpp', 'c++', 'h', 'cuh', 'cc', 'hh', 'c', 'hxx', 'hpp', 'cu', 'h++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,cpp,c++,h,cuh,cc,hh,c,hxx,hpp,cu,h++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'cuh', 'hh', 'hxx', 'hpp', 'h++'} will be assumed to be headers)

      Examples:
        --headers=h,cuh,hh,hxx,hpp,h++
        --headers=hpp,hxx
        --headers=hpp
