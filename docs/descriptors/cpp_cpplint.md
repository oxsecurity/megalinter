...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'h', 'h++', 'cuh', 'cc', 'c', 'hpp', 'cu', 'hh', 'cpp', 'c++', 'hxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,h,h++,cuh,cc,c,hpp,cu,hh,cpp,c++,hxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'h++', 'cuh', 'hpp', 'hh', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=h,h++,cuh,hpp,hh,hxx
        --headers=hpp,hxx
        --headers=hpp
