...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h', 'cxx', 'cc', 'cpp', 'c', 'cu', 'h++', 'hh', 'cuh', 'c++', 'hpp', 'hxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h,cxx,cc,cpp,c,cu,h++,hh,cuh,c++,hpp,hxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'h++', 'hh', 'cuh', 'hpp', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=h,h++,hh,cuh,hpp,hxx
        --headers=hpp,hxx
        --headers=hpp
