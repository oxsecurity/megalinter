...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['c++', 'h++', 'h', 'hxx', 'hh', 'cpp', 'cc', 'c', 'cuh', 'cu', 'hpp', 'cxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=c++,h++,h,hxx,hh,cpp,cc,c,cuh,cu,hpp,cxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'h', 'hxx', 'hh', 'cuh', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=h++,h,hxx,hh,cuh,hpp
        --headers=hpp,hxx
        --headers=hpp
