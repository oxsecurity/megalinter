...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cuh', 'h++', 'hpp', 'c', 'cpp', 'cc', 'cu', 'hxx', 'h', 'cxx', 'c++', 'hh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cuh,h++,hpp,c,cpp,cc,cu,hxx,h,cxx,c++,hh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'cuh', 'h++', 'hpp', 'hxx', 'h', 'hh'} will be assumed to be headers)

      Examples:
        --headers=cuh,h++,hpp,hxx,h,hh
        --headers=hpp,hxx
        --headers=hpp
