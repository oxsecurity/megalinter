...
description: checkov, devskim, dustilock, git_diff, gitleaks, grype, kics, secretlint, semgrep, syft, trivy, trivy-sbom, trufflehog are available to analyze REPOSITORY files in MegaLinter
---
...
| [**trivy-sbom**](repository_trivy_sbom.md)<br/>[_REPOSITORY_TRIVY_SBOM_](repository_trivy_sbom.md) | [![GitHub stars](https://img.shields.io/github/stars/aquasecurity/trivy?cacheSeconds=3600)](https://github.com/aquasecurity/trivy)                                                        |
