...
description: checkov, devskim, dustilock, git_diff, gitleaks, grype, kics, secretlint, semgrep, syft, trivy, trivy-sbom are available to analyze REPOSITORY files in MegaLinter
---
