...
description: checkov, devskim, dustilock, git_diff, gitleaks, kics, secretlint, semgrep, syft, trivy are available to analyze REPOSITORY files in MegaLinter
---
...
| [**kics**](repository_kics.md)<br/>[_REPOSITORY_KICS_](repository_kics.md)                         | [![GitHub stars](https://img.shields.io/github/stars/checkmarx/kics?cacheSeconds=3600)](https://github.com/checkmarx/kics)                                                                |
