...
description: checkov, devskim, dustilock, git_diff, betterleaks, grype, ls-lint, osv-scanner, secretlint, semgrep, syft, trivy, trivy-sbom, trufflehog, kingfisher are available to analyze REPOSITORY files in MegaLinter
---
...
| [**osv-scanner**](repository_osv_scanner.md)<br/>[_REPOSITORY_OSV_SCANNER_](repository_osv_scanner.md) | [![GitHub stars](https://img.shields.io/github/stars/google/osv-scanner?cacheSeconds=3600)](https://github.com/google/osv-scanner) ![sarif](https://shields.io/badge/-SARIF-orange)           |
