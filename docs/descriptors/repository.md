...
description: checkov, devskim, dustilock, git_diff, gitleaks, grype, kics, secretlint, semgrep, syft, trivy are available to analyze REPOSITORY files in MegaLinter
---
