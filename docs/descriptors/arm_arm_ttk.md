...
- Enable arm-ttk by adding `ARM_ARM_TTK` in [ENABLE_LINTERS variable](https://megalinter.io/9.0.0/configuration/#activation-and-deactivation)
- Disable arm-ttk by adding `ARM_ARM_TTK` in [DISABLE_LINTERS variable](https://megalinter.io/9.0.0/configuration/#activation-and-deactivation)
