...
description: eslint, ts-standard, prettier, biome are available to analyze TYPESCRIPT files in MegaLinter
---
...
| [**biome**](typescript_biome.md)<br/>[_TYPESCRIPT_BIOME_](typescript_biome.md)                      | [![GitHub stars](https://img.shields.io/github/stars/biomejs/biome?cacheSeconds=3600)](https://github.com/biomejs/biome) ![autofix](https://shields.io/badge/-autofix-green) ![sarif](https://shields.io/badge/-SARIF-orange)                                             |
