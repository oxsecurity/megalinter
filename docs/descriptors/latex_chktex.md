...
- Enable chktex by adding `LATEX_CHKTEX` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.12.0/configuration/#activation-and-deactivation)
- Disable chktex by adding `LATEX_CHKTEX` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.12.0/configuration/#activation-and-deactivation)
