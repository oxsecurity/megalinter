...
- Enable eslint by adding `JAVASCRIPT_ES` in [ENABLE_LINTERS variable](https://megalinter.io/9.4.0/configuration/#activation-and-deactivation)
- Disable eslint by adding `JAVASCRIPT_ES` in [DISABLE_LINTERS variable](https://megalinter.io/9.4.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `JAVASCRIPT_ES` in [APPLY_FIXES variable](https://megalinter.io/9.4.0/configuration/#apply-fixes)
...
- NPM packages (node.js):
  ...
  - [eslint-plugin-jest@29.15.0](https://www.npmjs.com/package/eslint-plugin-jest/v/29.15.0)
  ...
  - [eslint-plugin-vue@10.8.0](https://www.npmjs.com/package/eslint-plugin-vue/v/10.8.0)
