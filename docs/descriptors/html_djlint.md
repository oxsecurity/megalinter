...
- Enable djlint by adding `HTML_DJLINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.6.0/configuration/#activation-and-deactivation)
- Disable djlint by adding `HTML_DJLINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.6.0/configuration/#activation-and-deactivation)
...
ARG PIP_DJLINT_VERSION=1.39.4
```

- PIP packages (Python):
  - [djlint==1.39.4](https://pypi.org/project/djlint/1.39.4)
