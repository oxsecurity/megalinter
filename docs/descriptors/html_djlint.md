...
- Enable djlint by adding `HTML_DJLINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.3.0/configuration/#activation-and-deactivation)
- Disable djlint by adding `HTML_DJLINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.3.0/configuration/#activation-and-deactivation)
