...
- See [How to configure sql-lint rules](https://sql-lint.readthedocs.io/en/latest/files/configuration.html){target=_blank}
  - If custom `.sql-config.json` config file is not found, [.sql-config.json](https://github.com/mega-linter/mega-linter/tree/master/TEMPLATES/.sql-config.json){target=_blank} will be used
...
- Enable sql-lint by adding `SQL_SQL_LINT` in [ENABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
- Disable sql-lint by adding `SQL_SQL_LINT` in [DISABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
...
See documentation on https://mega-linter.github.io/descriptors/sql_sql_lint/
-----------------------------------------------
