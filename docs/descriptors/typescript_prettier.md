...
| TYPESCRIPT_PRETTIER_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling TYPESCRIPT_PRETTIER and its pre/post commands                                                                                                         | None                                            |
