...
- Enable clang-format by adding `CPP_CLANG_FORMAT` in [ENABLE_LINTERS variable](https://megalinter.io/9.3.0/configuration/#activation-and-deactivation)
- Disable clang-format by adding `CPP_CLANG_FORMAT` in [DISABLE_LINTERS variable](https://megalinter.io/9.3.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `CPP_CLANG_FORMAT` in [APPLY_FIXES variable](https://megalinter.io/9.3.0/configuration/#apply-fixes)
