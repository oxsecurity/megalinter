...
| POWERSHELL_POWERSHELL_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling POWERSHELL_POWERSHELL and its pre/post commands                                                                                | None                                                                |
