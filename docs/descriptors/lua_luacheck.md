...
# luacheck
[![GitHub stars](https://img.shields.io/github/stars/luarocks/luacheck?cacheSeconds=3600)](https://github.com/luarocks/luacheck) [![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/luarocks/luacheck?sort=semver)](https://github.com/luarocks/luacheck/releases) [![GitHub last commit](https://img.shields.io/github/last-commit/luarocks/luacheck)](https://github.com/luarocks/luacheck/commits) [![GitHub commit activity](https://img.shields.io/github/commit-activity/y/luarocks/luacheck)](https://github.com/luarocks/luacheck/graphs/commit-activity/) [![GitHub contributors](https://img.shields.io/github/contributors/luarocks/luacheck)](https://github.com/luarocks/luacheck/graphs/contributors/)
...
- Enable luacheck by adding `LUA_LUACHECK` in [ENABLE_LINTERS variable](https://megalinter.io/6.22.1/configuration/#activation-and-deactivation)
- Disable luacheck by adding `LUA_LUACHECK` in [DISABLE_LINTERS variable](https://megalinter.io/6.22.1/configuration/#activation-and-deactivation)
