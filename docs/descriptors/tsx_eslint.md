...
- Enable eslint by adding `TSX_ESLINT` in [ENABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
- Disable eslint by adding `TSX_ESLINT` in [DISABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `TSX_ESLINT` in [APPLY_FIXES variable](https://megalinter.io/10.0.0/configuration/#apply-fixes)
...
- NPM packages (node.js):
  ...
  - [@typescript-eslint/eslint-plugin@8.66.0](https://www.npmjs.com/package/@typescript-eslint/eslint-plugin/v/8.66.0)
  - [@typescript-eslint/parser@8.66.0](https://www.npmjs.com/package/@typescript-eslint/parser/v/8.66.0)
