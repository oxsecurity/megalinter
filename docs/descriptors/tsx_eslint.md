...
- Enable eslint by adding `TSX_ESLINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.10.0/configuration/#activation-and-deactivation)
- Disable eslint by adding `TSX_ESLINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.10.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `TSX_ESLINT` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.10.0/configuration/#apply-fixes)
