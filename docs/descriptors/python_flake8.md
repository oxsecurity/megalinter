...
- Enable flake8 by adding `PYTHON_FLAKE8` in [ENABLE_LINTERS variable](https://megalinter.io/8.5.0/configuration/#activation-and-deactivation)
- Disable flake8 by adding `PYTHON_FLAKE8` in [DISABLE_LINTERS variable](https://megalinter.io/8.5.0/configuration/#activation-and-deactivation)
