...
- Enable flake8 by adding `PYTHON_FLAKE8` in [ENABLE_LINTERS variable](https://megalinter.io/7.0.1/configuration/#activation-and-deactivation)
- Disable flake8 by adding `PYTHON_FLAKE8` in [DISABLE_LINTERS variable](https://megalinter.io/7.0.1/configuration/#activation-and-deactivation)
