...
- Enable flake8 by adding `PYTHON_FLAKE8` in [ENABLE_LINTERS variable](https://megalinter.github.io/v6-alpha/configuration/#activation-and-deactivation)
- Disable flake8 by adding `PYTHON_FLAKE8` in [DISABLE_LINTERS variable](https://megalinter.github.io/v6-alpha/configuration/#activation-and-deactivation)
...
optional arguments:
  ...
  --ignore errors       Comma-separated list of errors and warnings to ignore
                        ...
                        (Default: ['E123', 'W504', 'E121', 'E24', 'E226',
                        'E704', 'W503', 'E126'])
