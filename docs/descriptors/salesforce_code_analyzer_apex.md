...
- Enable code-analyzer-apex by adding `SALESFORCE_CODE_ANALYZER_APEX` in [ENABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
- Disable code-analyzer-apex by adding `SALESFORCE_CODE_ANALYZER_APEX` in [DISABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
...
Streaming logs in real time to:
    /tmp/sfca-2026_08_08_08_34_31_043.log
