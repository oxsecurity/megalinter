...
| VBDOTNET_DOTNET_FORMAT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling VBDOTNET_DOTNET_FORMAT and its pre/post commands                                                                               | None               |
