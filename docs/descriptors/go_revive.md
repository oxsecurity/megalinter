...
- Enable revive by adding `GO_REVIVE` in [ENABLE_LINTERS variable](https://megalinter.io/9.0.1/configuration/#activation-and-deactivation)
- Disable revive by adding `GO_REVIVE` in [DISABLE_LINTERS variable](https://megalinter.io/9.0.1/configuration/#activation-and-deactivation)
