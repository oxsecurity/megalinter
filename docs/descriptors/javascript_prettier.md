...
- Enable prettier by adding `JAVASCRIPT_PRETTIER` in [ENABLE_LINTERS variable](https://megalinter.io/9.0.0/configuration/#activation-and-deactivation)
- Disable prettier by adding `JAVASCRIPT_PRETTIER` in [DISABLE_LINTERS variable](https://megalinter.io/9.0.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `JAVASCRIPT_PRETTIER` in [APPLY_FIXES variable](https://megalinter.io/9.0.0/configuration/#apply-fixes)
