...
| TYPESCRIPT_STANDARD_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling TYPESCRIPT_STANDARD and its pre/post commands                                                                                                         | None               |
