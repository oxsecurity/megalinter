...
ARG GEM_RUBOCOP_VERSION=1.79.2
...
ARG GEM_RUBOCOP_RAILS_VERSION=2.33.1
...
- GEM packages (Ruby) :
  - [rubocop:1.79.2](https://rubygems.org/gems/rubocop/versions/1.79.2)
  ...
  - [rubocop-rails:2.33.1](https://rubygems.org/gems/rubocop-rails/versions/2.33.1)
