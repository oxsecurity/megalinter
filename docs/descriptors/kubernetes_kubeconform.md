...
| KUBERNETES_KUBECONFORM_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling KUBERNETES_KUBECONFORM and its pre/post commands                                                                                                      | None                         |
