...
- Enable code-analyzer-lwc by adding `SALESFORCE_CODE_ANALYZER_LWC` in [ENABLE_LINTERS variable](https://megalinter.io/9.6.0/configuration/#activation-and-deactivation)
- Disable code-analyzer-lwc by adding `SALESFORCE_CODE_ANALYZER_LWC` in [DISABLE_LINTERS variable](https://megalinter.io/9.6.0/configuration/#activation-and-deactivation)
...
Streaming logs in real time to:
    /tmp/sfca-2026_06_27_22_36_58_177.log
