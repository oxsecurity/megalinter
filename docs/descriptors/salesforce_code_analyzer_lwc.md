...
- Enable code-analyzer-lwc by adding `SALESFORCE_CODE_ANALYZER_LWC` in [ENABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
- Disable code-analyzer-lwc by adding `SALESFORCE_CODE_ANALYZER_LWC` in [DISABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
...
Streaming logs in real time to:
    /tmp/sfca-2026_08_08_08_35_00_171.log
