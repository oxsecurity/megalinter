...
- Enable code-analyzer-lwc by adding `SALESFORCE_CODE_ANALYZER_LWC` in [ENABLE_LINTERS variable](https://megalinter.io/9.2.0/configuration/#activation-and-deactivation)
- Disable code-analyzer-lwc by adding `SALESFORCE_CODE_ANALYZER_LWC` in [DISABLE_LINTERS variable](https://megalinter.io/9.2.0/configuration/#activation-and-deactivation)
...
Streaming logs in real time to:
    /tmp/sfca-2025_11_29_11_49_35_705.log
