...
- Enable php by adding `PHP_BUILTIN` in [ENABLE_LINTERS variable](https://megalinter.io/latest/configuration/#activation-and-deactivation)
- Disable php by adding `PHP_BUILTIN` in [DISABLE_LINTERS variable](https://megalinter.io/latest/configuration/#activation-and-deactivation)
