...
| KOTLIN_KTLINT_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with KOTLIN_KTLINT_CLI_LINT_MODE = project 
| KOTLIN_KTLINT_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with KOTLIN_KTLINT_CLI_LINT_MODE = project 
