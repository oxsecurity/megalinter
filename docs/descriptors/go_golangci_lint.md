...
- Enable golangci-lint by adding `GO_GOLANGCI_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/8.6.0/configuration/#activation-and-deactivation)
- Disable golangci-lint by adding `GO_GOLANGCI_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/8.6.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `GO_GOLANGCI_LINT` in [APPLY_FIXES variable](https://megalinter.io/8.6.0/configuration/#apply-fixes)
