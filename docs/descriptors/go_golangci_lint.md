...
| GO_GOLANGCI_LINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling GO_GOLANGCI_LINT and its pre/post commands                                                                                                            | None                                            |
