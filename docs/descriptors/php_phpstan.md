...
- Enable phpstan by adding `PHP_PHPSTAN` in [ENABLE_LINTERS variable](https://megalinter.io/7.1.0/configuration/#activation-and-deactivation)
- Disable phpstan by adding `PHP_PHPSTAN` in [DISABLE_LINTERS variable](https://megalinter.io/7.1.0/configuration/#activation-and-deactivation)
