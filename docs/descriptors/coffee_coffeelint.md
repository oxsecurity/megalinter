...
| COFFEE_COFFEELINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling COFFEE_COFFEELINT and its pre/post commands                                                                                    | None                                            |
