...
- Enable rst-lint by adding `RST_RST_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.0.0/configuration/#activation-and-deactivation)
- Disable rst-lint by adding `RST_RST_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.0.0/configuration/#activation-and-deactivation)
