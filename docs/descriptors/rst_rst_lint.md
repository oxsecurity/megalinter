...
- Enable rst-lint by adding `RST_RST_LINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.0/configuration/#activation-and-deactivation)
- Disable rst-lint by adding `RST_RST_LINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.0/configuration/#activation-and-deactivation)
