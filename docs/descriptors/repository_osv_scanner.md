...
| REPOSITORY_OSV_SCANNER_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with REPOSITORY_OSV_SCANNER_CLI_LINT_MODE = project
| REPOSITORY_OSV_SCANNER_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with REPOSITORY_OSV_SCANNER_CLI_LINT_MODE = project
