...
- Enable kics by adding `REPOSITORY_KICS` in [ENABLE_LINTERS variable](https://megalinter.io/7.6.0/configuration/#activation-and-deactivation)
- Disable kics by adding `REPOSITORY_KICS` in [DISABLE_LINTERS variable](https://megalinter.io/7.6.0/configuration/#activation-and-deactivation)
