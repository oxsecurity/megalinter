...
- Enable eslint by adding `TYPESCRIPT_ES` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.11.0/configuration/#activation-and-deactivation)
- Disable eslint by adding `TYPESCRIPT_ES` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.11.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `TYPESCRIPT_ES` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.11.0/configuration/#apply-fixes)
