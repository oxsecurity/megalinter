...
| ACTION_ZIZMOR_CLI_LINT_MODE               | Override default CLI lint mode<br/>- `file`: Calls the linter for each file                                                                                                                  | `list_of_files`                                 |
...
- zizmor is called one time by identified file (`file` CLI lint mode)
