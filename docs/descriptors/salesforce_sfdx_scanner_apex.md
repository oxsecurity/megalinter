...
```shell
 ›   Warning: @salesforce/cli update available from 2.81.9 to 2.82.6.
...
COMMANDS
 ...
 ›   Warning: @salesforce/cli update available from 2.81.9 to 2.82.6.
 ›   Warning: Plugin @salesforce/sfdx-scanner (4.11.0) differs from the version
 ›    specified by sf (4.10.0)
