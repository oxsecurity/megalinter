...
- Enable sfdx-scanner-apex by adding `SALESFORCE_SFDX_SCANNER_APEX` in [ENABLE_LINTERS variable](https://megalinter.io/8.4.1/configuration/#activation-and-deactivation)
- Disable sfdx-scanner-apex by adding `SALESFORCE_SFDX_SCANNER_APEX` in [DISABLE_LINTERS variable](https://megalinter.io/8.4.1/configuration/#activation-and-deactivation)
...
COMMANDS
 ...
 ›   Warning: @salesforce/cli update available from 2.72.21 to 2.73.9.
 ›   Warning: Plugin @salesforce/sfdx-scanner (4.8.0) differs from the version
 ›   specified by sf (4.7.0)
