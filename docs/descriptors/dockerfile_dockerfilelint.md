...
- See [How to configure dockerfilelint rules](https://github.com/replicatedhq/dockerfilelint#configuring){target=_blank}
  - If custom `.dockerfilelintrc` config file is not found, [.dockerfilelintrc](https://github.com/megalinter/megalinter/tree/master/TEMPLATES/.dockerfilelintrc){target=_blank} will be used
