...
- See [How to configure dockerfilelint rules](https://github.com/replicatedhq/dockerfilelint#configuring){target=_blank}
  - If custom `.dockerfilelintrc` config file is not found, [.dockerfilelintrc](https://github.com/mega-linter/mega-linter/tree/master/TEMPLATES/.dockerfilelintrc){target=_blank} will be used
...
- Enable dockerfilelint by adding `DOCKERFILE_DOCKERFILELINT` in [ENABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
- Disable dockerfilelint by adding `DOCKERFILE_DOCKERFILELINT` in [DISABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
...
See documentation on https://mega-linter.github.io/descriptors/dockerfile_dockerfilelint/
-----------------------------------------------
