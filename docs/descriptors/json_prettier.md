...
- Enable prettier by adding `JSON_PRETTIER` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#activation-and-deactivation)
- Disable prettier by adding `JSON_PRETTIER` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `JSON_PRETTIER` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#apply-fixes)
