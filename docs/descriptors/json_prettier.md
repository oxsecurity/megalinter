...
- Enable prettier by adding `JSON_PRETTIER` in [ENABLE_LINTERS variable](https://megalinter.io/8.4.2/configuration/#activation-and-deactivation)
- Disable prettier by adding `JSON_PRETTIER` in [DISABLE_LINTERS variable](https://megalinter.io/8.4.2/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `JSON_PRETTIER` in [APPLY_FIXES variable](https://megalinter.io/8.4.2/configuration/#apply-fixes)
