...
- Enable raku by adding `RAKU_RAKU` in [ENABLE_LINTERS variable](https://megalinter.io/8.5.0/configuration/#activation-and-deactivation)
- Disable raku by adding `RAKU_RAKU` in [DISABLE_LINTERS variable](https://megalinter.io/8.5.0/configuration/#activation-and-deactivation)
