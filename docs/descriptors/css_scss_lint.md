...
- Enable scss-lint by adding `CSS_SCSS_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.11.1/configuration/#activation-and-deactivation)
- Disable scss-lint by adding `CSS_SCSS_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.11.1/configuration/#activation-and-deactivation)
