...
- Enable kics by adding `TERRAFORM_KICS` in [ENABLE_LINTERS variable](https://megalinter.io/6.19.0/configuration/#activation-and-deactivation)
- Disable kics by adding `TERRAFORM_KICS` in [DISABLE_LINTERS variable](https://megalinter.io/6.19.0/configuration/#activation-and-deactivation)
