...
- Enable ansible-lint by adding `ANSIBLE_ANSIBLE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.0.4/configuration/#activation-and-deactivation)
- Disable ansible-lint by adding `ANSIBLE_ANSIBLE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.0.4/configuration/#activation-and-deactivation)
...
- PIP packages (Python):
  - [ansible-lint=='6.16.2'](https://pypi.org/project/ansible-lint/'6.16.2')
