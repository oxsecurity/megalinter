...
| ANSIBLE_ANSIBLE_LINT_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with ANSIBLE_ANSIBLE_LINT_CLI_LINT_MODE = project
| ANSIBLE_ANSIBLE_LINT_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with ANSIBLE_ANSIBLE_LINT_CLI_LINT_MODE = project
