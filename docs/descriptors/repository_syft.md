...
- Enable syft by adding `REPOSITORY_SYFT` in [ENABLE_LINTERS variable](https://megalinter.io/7.3.0/configuration/#activation-and-deactivation)
- Disable syft by adding `REPOSITORY_SYFT` in [DISABLE_LINTERS variable](https://megalinter.io/7.3.0/configuration/#activation-and-deactivation)
