...
- See [How to disable checkstyle rules in files](https://checkstyle.sourceforge.io/filters/suppresswarningsfilter.html#SuppressWarningsFilter){target=_blank}
...
- Enable checkstyle by adding `JAVA_CHECKSTYLE` in [ENABLE_LINTERS variable](https://megalinter.io/7.4.0/configuration/#activation-and-deactivation)
- Disable checkstyle by adding `JAVA_CHECKSTYLE` in [DISABLE_LINTERS variable](https://megalinter.io/7.4.0/configuration/#activation-and-deactivation)
