...
| JAVA_CHECKSTYLE_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling JAVA_CHECKSTYLE and its pre/post commands                                                                                                             | None                                            |
