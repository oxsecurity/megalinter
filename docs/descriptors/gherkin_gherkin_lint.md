...
| GHERKIN_GHERKIN_LINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling GHERKIN_GHERKIN_LINT and its pre/post commands                                                                                 | None                                            |
