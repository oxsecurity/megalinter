...
- Enable clippy by adding `RUST_CLIPPY` in [ENABLE_LINTERS variable](https://megalinter.io/7.9.0/configuration/#activation-and-deactivation)
- Disable clippy by adding `RUST_CLIPPY` in [DISABLE_LINTERS variable](https://megalinter.io/7.9.0/configuration/#activation-and-deactivation)
