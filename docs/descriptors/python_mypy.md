...
- Enable mypy by adding `PYTHON_MYPY` in [ENABLE_LINTERS variable](https://megalinter.io/8.3.0/configuration/#activation-and-deactivation)
- Disable mypy by adding `PYTHON_MYPY` in [DISABLE_LINTERS variable](https://megalinter.io/8.3.0/configuration/#activation-and-deactivation)
