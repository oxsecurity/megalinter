...
- Enable shfmt by adding `BASH_SHFMT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.8.0/configuration/#activation-and-deactivation)
- Disable shfmt by adding `BASH_SHFMT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.8.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `BASH_SHFMT` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.8.0/configuration/#apply-fixes)
