...
- Enable code-analyzer-apexguru by adding `SALESFORCE_CODE_ANALYZER_APEXGURU` in [ENABLE_LINTERS variable](https://megalinter.io/beta/configuration/#activation-and-deactivation)
- Disable code-analyzer-apexguru by adding `SALESFORCE_CODE_ANALYZER_APEXGURU` in [DISABLE_LINTERS variable](https://megalinter.io/beta/configuration/#activation-and-deactivation)
