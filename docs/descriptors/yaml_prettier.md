...
| YAML_PRETTIER_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with YAML_PRETTIER_CLI_LINT_MODE = project 
| YAML_PRETTIER_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with YAML_PRETTIER_CLI_LINT_MODE = project 
