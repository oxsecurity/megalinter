...
| CLOUDFORMATION_CFN_LINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling CLOUDFORMATION_CFN_LINT and its pre/post commands                                                                                                     | None                                            |
