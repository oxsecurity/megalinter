...
- Enable devskim by adding `REPOSITORY_DEVSKIM` in [ENABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
- Disable devskim by adding `REPOSITORY_DEVSKIM` in [DISABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
