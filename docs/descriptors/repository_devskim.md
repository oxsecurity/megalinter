...
| REPOSITORY_DEVSKIM_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling REPOSITORY_DEVSKIM and its pre/post commands | None          |
