...
- See [How to configure secretlint rules](https://github.com/secretlint/secretlint#configuration){target=_blank}
  - If custom `.secretlintrc.json` config file is not found, [.secretlintrc.json](https://github.com/mega-linter/mega-linter/tree/master/TEMPLATES/.secretlintrc.json){target=_blank} will be used
...
- Enable secretlint by adding `CREDENTIALS_SECRETLINT` in [ENABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
- Disable secretlint by adding `CREDENTIALS_SECRETLINT` in [DISABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
