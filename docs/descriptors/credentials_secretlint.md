...
- See [How to configure secretlint rules](https://github.com/secretlint/secretlint#configuration){target=_blank}
  - If custom `.secretlintrc.json` config file is not found, [.secretlintrc.json](https://github.com/megalinter/megalinter/tree/master/TEMPLATES/.secretlintrc.json){target=_blank} will be used
