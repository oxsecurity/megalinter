...
# <a href="https://pmd.github.io/" target="blank" title="Visit linter Web Site"><img src="https://pmd.github.io/img/pmd_logo.png" alt="pmd" height="100px" class="megalinter-logo"></a>pmd [![GitHub last commit](https://img.shields.io/github/last-commit/pmd/pmd)](https://github.com/pmd/pmd/commits)
...
- Enable pmd by adding `JAVA_PMD` in [ENABLE_LINTERS variable](https://megalinter.io/6.17.0/configuration/#activation-and-deactivation)
- Disable pmd by adding `JAVA_PMD` in [DISABLE_LINTERS variable](https://megalinter.io/6.17.0/configuration/#activation-and-deactivation)
