...
- Enable pmd by adding `JAVA_PMD` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#activation-and-deactivation)
- Disable pmd by adding `JAVA_PMD` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.7.1/configuration/#activation-and-deactivation)
