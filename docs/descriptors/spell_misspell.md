...
- Enable misspell by adding `SPELL_MISSPELL` in [ENABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
- Disable misspell by adding `SPELL_MISSPELL` in [DISABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `SPELL_MISSPELL` in [APPLY_FIXES variable](https://mega-linter.github.io/configuration/#apply-fixes)
...
See documentation on https://mega-linter.github.io/descriptors/spell_misspell/
-----------------------------------------------
