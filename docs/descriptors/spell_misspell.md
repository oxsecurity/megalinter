...
>
> misspell is not maintained since 2018 so will be removed in a future version
>
> You should disable misspell by adding it in DISABLE_LINTERS property.
>
...
- Enable **autofixes** by adding `SPELL_MISSPELL` in [APPLY_FIXES variable](https://megalinter.io/beta/configuration/#apply-fixes)
