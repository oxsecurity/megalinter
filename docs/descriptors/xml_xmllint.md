...
- Enable xmllint by adding `XML_XMLLINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.21.0/configuration/#activation-and-deactivation)
- Disable xmllint by adding `XML_XMLLINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.21.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `XML_XMLLINT` in [APPLY_FIXES variable](https://megalinter.io/6.21.0/configuration/#apply-fixes)
