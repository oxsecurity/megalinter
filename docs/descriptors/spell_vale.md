...
- Enable vale by adding `SPELL_VALE` in [ENABLE_LINTERS variable](https://megalinter.io/7.10.0/configuration/#activation-and-deactivation)
- Disable vale by adding `SPELL_VALE` in [DISABLE_LINTERS variable](https://megalinter.io/7.10.0/configuration/#activation-and-deactivation)
