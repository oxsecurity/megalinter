...
- Enable psalm by adding `PHP_PSALM` in [ENABLE_LINTERS variable](https://megalinter.io/8.3.1/configuration/#activation-and-deactivation)
- Disable psalm by adding `PHP_PSALM` in [DISABLE_LINTERS variable](https://megalinter.io/8.3.1/configuration/#activation-and-deactivation)
