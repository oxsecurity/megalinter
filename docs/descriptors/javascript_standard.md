...
| JAVASCRIPT_STANDARD_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling JAVASCRIPT_STANDARD and its pre/post commands                                                                                                         | None               |
