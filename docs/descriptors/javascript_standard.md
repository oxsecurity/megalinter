...
- Enable standard by adding `JAVASCRIPT_STANDARD` in [ENABLE_LINTERS variable](https://megalinter.io/7.7.0/configuration/#activation-and-deactivation)
- Disable standard by adding `JAVASCRIPT_STANDARD` in [DISABLE_LINTERS variable](https://megalinter.io/7.7.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `JAVASCRIPT_STANDARD` in [APPLY_FIXES variable](https://megalinter.io/7.7.0/configuration/#apply-fixes)
