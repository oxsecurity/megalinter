...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cu', 'h++', 'c', 'cxx', 'h', 'hxx', 'cc', 'hpp', 'c++', 'cpp', 'cuh', 'hh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cu,h++,c,cxx,h,hxx,cc,hpp,c++,cpp,cuh,hh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'h', 'hxx', 'hpp', 'cuh', 'hh'} will be assumed to be headers)

      Examples:
        --headers=h++,h,hxx,hpp,cuh,hh
        --headers=hpp,hxx
        --headers=hpp
