...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cuh', 'hh', 'h++', 'hpp', 'cxx', 'c', 'cpp', 'hxx', 'cc', 'cu', 'c++', 'h'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cuh,hh,h++,hpp,cxx,c,cpp,hxx,cc,cu,c++,h
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'cuh', 'hh', 'h++', 'hpp', 'hxx', 'h'} will be assumed to be headers)

      Examples:
        --headers=cuh,hh,h++,hpp,hxx,h
        --headers=hpp,hxx
        --headers=hpp
