...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['c', 'cxx', 'cuh', 'cc', 'cu', 'c++', 'h', 'hxx', 'hpp', 'hh', 'cpp', 'h++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=c,cxx,cuh,cc,cu,c++,h,hxx,hpp,hh,cpp,h++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'cuh', 'h', 'hxx', 'hpp', 'hh', 'h++'} will be assumed to be headers)

      Examples:
        --headers=cuh,h,hxx,hpp,hh,h++
        --headers=hpp,hxx
        --headers=hpp
