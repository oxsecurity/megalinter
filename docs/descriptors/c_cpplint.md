...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'h++', 'c', 'hh', 'cuh', 'hxx', 'cu', 'cxx', 'h', 'cc', 'c++', 'hpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,h++,c,hh,cuh,hxx,cu,cxx,h,cc,c++,hpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hh', 'cuh', 'hxx', 'h', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=h++,hh,cuh,hxx,h,hpp
        --headers=hpp,hxx
        --headers=hpp
