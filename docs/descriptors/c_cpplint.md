...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'hxx', 'c++', 'h++', 'cxx', 'cc', 'c', 'cpp', 'h', 'cuh', 'hh', 'cu'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,hxx,c++,h++,cxx,cc,c,cpp,h,cuh,hh,cu
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'hxx', 'h++', 'h', 'cuh', 'hh'} will be assumed to be headers)

      Examples:
        --headers=hpp,hxx,h++,h,cuh,hh
        --headers=hpp,hxx
        --headers=hpp
