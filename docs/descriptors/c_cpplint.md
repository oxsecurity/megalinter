...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'cc', 'cxx', 'hxx', 'cpp', 'c++', 'h', 'cuh', 'c', 'hpp', 'cu', 'h++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,cc,cxx,hxx,cpp,c++,h,cuh,c,hpp,cu,h++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'hxx', 'h', 'cuh', 'hpp', 'h++'} will be assumed to be headers)

      Examples:
        --headers=hh,hxx,h,cuh,hpp,h++
        --headers=hpp,hxx
        --headers=hpp
