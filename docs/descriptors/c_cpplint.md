...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'cxx', 'h', 'hh', 'h++', 'c++', 'cu', 'c', 'hxx', 'cuh', 'cc', 'hpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,cxx,h,hh,h++,c++,cu,c,hxx,cuh,cc,hpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'hh', 'h++', 'hxx', 'cuh', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=h,hh,h++,hxx,cuh,hpp
        --headers=hpp,hxx
        --headers=hpp
