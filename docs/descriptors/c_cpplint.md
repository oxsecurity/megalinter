...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'h++', 'hpp', 'cpp', 'c++', 'cu', 'hxx', 'cc', 'h', 'cxx', 'cuh', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,h++,hpp,cpp,c++,cu,hxx,cc,h,cxx,cuh,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'h++', 'hpp', 'hxx', 'h', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hh,h++,hpp,hxx,h,cuh
        --headers=hpp,hxx
        --headers=hpp
