...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cc', 'c++', 'hxx', 'cuh', 'cxx', 'cpp', 'hh', 'cu', 'h', 'h++', 'c', 'hpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cc,c++,hxx,cuh,cxx,cpp,hh,cu,h,h++,c,hpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'cuh', 'hh', 'h', 'h++', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=hxx,cuh,hh,h,h++,hpp
        --headers=hpp,hxx
        --headers=hpp
