...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'cxx', 'h', 'h++', 'c++', 'c', 'cuh', 'hpp', 'cu', 'hxx', 'cpp', 'cc'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,cxx,h,h++,c++,c,cuh,hpp,cu,hxx,cpp,cc
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'h', 'h++', 'cuh', 'hpp', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=hh,h,h++,cuh,hpp,hxx
        --headers=hpp,hxx
        --headers=hpp
