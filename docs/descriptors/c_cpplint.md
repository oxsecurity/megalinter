...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'h', 'h++', 'c++', 'hh', 'hpp', 'cu', 'cpp', 'cc', 'cuh', 'c', 'hxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,h,h++,c++,hh,hpp,cu,cpp,cc,cuh,c,hxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hh', 'hpp', 'cuh', 'hxx', 'h'} will be assumed to be headers)

      Examples:
        --headers=h++,hh,hpp,cuh,hxx,h
        --headers=hpp,hxx
        --headers=hpp
