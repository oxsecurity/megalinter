...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'hh', 'h++', 'c', 'cuh', 'hxx', 'h', 'c++', 'cxx', 'cu', 'cc', 'cpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,hh,h++,c,cuh,hxx,h,c++,cxx,cu,cc,cpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'hh', 'h++', 'cuh', 'hxx', 'h'} will be assumed to be headers)

      Examples:
        --headers=hpp,hh,h++,cuh,hxx,h
        --headers=hpp,hxx
        --headers=hpp
