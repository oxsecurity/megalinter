...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cu', 'h++', 'cxx', 'hh', 'c++', 'cc', 'cpp', 'hxx', 'cuh', 'hpp', 'c', 'h'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cu,h++,cxx,hh,c++,cc,cpp,hxx,cuh,hpp,c,h
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hh', 'hxx', 'cuh', 'hpp', 'h'} will be assumed to be headers)

      Examples:
        --headers=h++,hh,hxx,cuh,hpp,h
        --headers=hpp,hxx
        --headers=hpp
