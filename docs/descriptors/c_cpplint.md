...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'c++', 'hh', 'hxx', 'hpp', 'h', 'cc', 'cxx', 'h++', 'cu', 'c', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,c++,hh,hxx,hpp,h,cc,cxx,h++,cu,c,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'hxx', 'hpp', 'h', 'h++', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hh,hxx,hpp,h,h++,cuh
        --headers=hpp,hxx
        --headers=hpp
