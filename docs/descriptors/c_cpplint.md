...
- Enable cpplint by adding `C_CPPLINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.8.0/configuration/#activation-and-deactivation)
- Disable cpplint by adding `C_CPPLINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.8.0/configuration/#activation-and-deactivation)
