...
- Enable cpplint by adding `C_CPPLINT` in [ENABLE_LINTERS variable](https://megalinter.io/8.0.0/configuration/#activation-and-deactivation)
- Disable cpplint by adding `C_CPPLINT` in [DISABLE_LINTERS variable](https://megalinter.io/8.0.0/configuration/#activation-and-deactivation)
