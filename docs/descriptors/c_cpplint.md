...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'hxx', 'cxx', 'hpp', 'h++', 'c', 'cu', 'hh', 'cc', 'h', 'cuh', 'c++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,hxx,cxx,hpp,h++,c,cu,hh,cc,h,cuh,c++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'hpp', 'h++', 'hh', 'h', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hxx,hpp,h++,hh,h,cuh
        --headers=hpp,hxx
        --headers=hpp
