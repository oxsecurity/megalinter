...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'cuh', 'h', 'cc', 'hxx', 'cpp', 'c++', 'hpp', 'h++', 'cu', 'c', 'cxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,cuh,h,cc,hxx,cpp,c++,hpp,h++,cu,c,cxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'cuh', 'h', 'hxx', 'hpp', 'h++'} will be assumed to be headers)

      Examples:
        --headers=hh,cuh,h,hxx,hpp,h++
        --headers=hpp,hxx
        --headers=hpp
