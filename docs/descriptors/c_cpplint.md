...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'cxx', 'h', 'h++', 'c++', 'hpp', 'c', 'cc', 'cpp', 'cu', 'hxx', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,cxx,h,h++,c++,hpp,c,cc,cpp,cu,hxx,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'h', 'h++', 'hpp', 'hxx', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hh,h,h++,hpp,hxx,cuh
        --headers=hpp,hxx
        --headers=hpp
