...
- Enable cpplint by adding `C_CPPLINT` in [ENABLE_LINTERS variable](https://megalinter.io/8.4.2/configuration/#activation-and-deactivation)
- Disable cpplint by adding `C_CPPLINT` in [DISABLE_LINTERS variable](https://megalinter.io/8.4.2/configuration/#activation-and-deactivation)
