...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'cu', 'hxx', 'cc', 'c', 'c++', 'h', 'cpp', 'hpp', 'h++', 'cuh', 'cxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,cu,hxx,cc,c,c++,h,cpp,hpp,h++,cuh,cxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'hxx', 'h', 'hpp', 'h++', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hh,hxx,h,hpp,h++,cuh
        --headers=hpp,hxx
        --headers=hpp
