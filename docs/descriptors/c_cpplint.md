...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'cu', 'hxx', 'h', 'cuh', 'c++', 'hpp', 'h++', 'hh', 'c', 'cc', 'cpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,cu,hxx,h,cuh,c++,hpp,h++,hh,c,cc,cpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'h', 'cuh', 'h++', 'hpp', 'hh'} will be assumed to be headers)

      Examples:
        --headers=hxx,h,cuh,h++,hpp,hh
        --headers=hpp,hxx
        --headers=hpp
