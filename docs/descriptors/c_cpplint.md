...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h++', 'hxx', 'h', 'cxx', 'cu', 'hpp', 'c++', 'hh', 'cc', 'cpp', 'cuh', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h++,hxx,h,cxx,cu,hpp,c++,hh,cc,cpp,cuh,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hxx', 'h', 'hpp', 'hh', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=h++,hxx,h,hpp,hh,cuh
        --headers=hpp,hxx
        --headers=hpp
