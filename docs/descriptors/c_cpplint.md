...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h', 'cu', 'cc', 'cpp', 'cxx', 'c++', 'hpp', 'c', 'h++', 'hh', 'hxx', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h,cu,cc,cpp,cxx,c++,hpp,c,h++,hh,hxx,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'hpp', 'h++', 'hh', 'hxx', 'cuh'} will be assumed to be headers)
