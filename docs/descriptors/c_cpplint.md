...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h', 'hpp', 'cxx', 'c', 'cpp', 'cu', 'hxx', 'cc', 'c++', 'h++', 'hh', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h,hpp,cxx,c,cpp,cu,hxx,cc,c++,h++,hh,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'hpp', 'hxx', 'h++', 'hh', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=h,hpp,hxx,h++,hh,cuh
        --headers=hpp,hxx
        --headers=hpp
