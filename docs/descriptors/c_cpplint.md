...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'c', 'hpp', 'h', 'cc', 'c++', 'cxx', 'hxx', 'cuh', 'h++', 'cu', 'hh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,c,hpp,h,cc,c++,cxx,hxx,cuh,h++,cu,hh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'h', 'hxx', 'cuh', 'h++', 'hh'} will be assumed to be headers)

      Examples:
        --headers=hpp,h,hxx,cuh,h++,hh
        --headers=hpp,hxx
        --headers=hpp
