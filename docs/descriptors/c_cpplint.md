...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'h', 'cpp', 'h++', 'hpp', 'hh', 'cc', 'c', 'cu', 'cuh', 'c++', 'hxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,h,cpp,h++,hpp,hh,cc,c,cu,cuh,c++,hxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'h++', 'hpp', 'hh', 'cuh', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=h,h++,hpp,hh,cuh,hxx
        --headers=hpp,hxx
        --headers=hpp
