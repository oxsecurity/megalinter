...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'c++', 'cpp', 'cuh', 'h++', 'hxx', 'c', 'h', 'cu', 'hh', 'hpp', 'cc'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,c++,cpp,cuh,h++,hxx,c,h,cu,hh,hpp,cc
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hxx', 'cuh', 'h', 'hh', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=h++,hxx,cuh,h,hh,hpp
        --headers=hpp,hxx
        --headers=hpp
