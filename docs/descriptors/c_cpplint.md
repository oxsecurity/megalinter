...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hxx', 'c', 'hh', 'h', 'c++', 'cc', 'cxx', 'h++', 'cpp', 'cu', 'hpp', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hxx,c,hh,h,c++,cc,cxx,h++,cpp,cu,hpp,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'hh', 'h', 'h++', 'hpp', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hxx,hh,h,h++,hpp,cuh
        --headers=hpp,hxx
        --headers=hpp
