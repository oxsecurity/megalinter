...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h', 'cxx', 'hh', 'hxx', 'cpp', 'hpp', 'cuh', 'c++', 'h++', 'c', 'cc', 'cu'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h,cxx,hh,hxx,cpp,hpp,cuh,c++,h++,c,cc,cu
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'hh', 'hxx', 'hpp', 'cuh', 'h++'} will be assumed to be headers)

      Examples:
        --headers=h,hh,hxx,hpp,cuh,h++
        --headers=hpp,hxx
        --headers=hpp
