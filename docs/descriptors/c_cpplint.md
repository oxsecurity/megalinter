...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'h++', 'hh', 'cxx', 'cpp', 'cu', 'cc', 'h', 'cuh', 'c++', 'c', 'hxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,h++,hh,cxx,cpp,cu,cc,h,cuh,c++,c,hxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'h++', 'hh', 'h', 'cuh', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=hpp,h++,hh,h,cuh,hxx
        --headers=hpp,hxx
        --headers=hpp
