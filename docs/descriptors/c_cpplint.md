...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'cc', 'c++', 'cuh', 'hh', 'hpp', 'cxx', 'cu', 'hxx', 'h++', 'c', 'h'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,cc,c++,cuh,hh,hpp,cxx,cu,hxx,h++,c,h
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'cuh', 'hh', 'hpp', 'hxx', 'h++', 'h'} will be assumed to be headers)

      Examples:
        --headers=cuh,hh,hpp,hxx,h++,h
        --headers=hpp,hxx
        --headers=hpp
