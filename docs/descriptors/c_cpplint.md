...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'hh', 'c++', 'cu', 'h++', 'cc', 'cxx', 'cpp', 'h', 'c', 'hxx', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,hh,c++,cu,h++,cc,cxx,cpp,h,c,hxx,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'hh', 'h++', 'h', 'hxx', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hpp,hh,h++,h,hxx,cuh
        --headers=hpp,hxx
        --headers=hpp
