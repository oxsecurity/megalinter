...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'hxx', 'h', 'cpp', 'c', 'cu', 'c++', 'hpp', 'cuh', 'cxx', 'h++', 'cc'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,hxx,h,cpp,c,cu,c++,hpp,cuh,cxx,h++,cc
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'hxx', 'h', 'hpp', 'cuh', 'h++'} will be assumed to be headers)

      Examples:
        --headers=hh,hxx,h,hpp,cuh,h++
        --headers=hpp,hxx
        --headers=hpp
