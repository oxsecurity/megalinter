...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['c++', 'hxx', 'c', 'h++', 'cuh', 'hh', 'cc', 'h', 'cxx', 'cu', 'cpp', 'hpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=c++,hxx,c,h++,cuh,hh,cc,h,cxx,cu,cpp,hpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'h++', 'hh', 'cuh', 'h', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=hxx,h++,hh,cuh,h,hpp
        --headers=hpp,hxx
        --headers=hpp
