...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'h', 'h++', 'c', 'cpp', 'cc', 'cu', 'cxx', 'c++', 'hxx', 'hh', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,h,h++,c,cpp,cc,cu,cxx,c++,hxx,hh,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'h', 'h++', 'hxx', 'hh', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hpp,h,h++,hxx,hh,cuh
        --headers=hpp,hxx
        --headers=hpp
