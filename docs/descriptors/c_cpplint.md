...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h', 'c', 'hh', 'cuh', 'c++', 'cxx', 'cpp', 'cc', 'cu', 'hpp', 'h++', 'hxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h,c,hh,cuh,c++,cxx,cpp,cc,cu,hpp,h++,hxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'hh', 'cuh', 'hpp', 'h++', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=h,hh,cuh,hpp,h++,hxx
        --headers=hpp,hxx
        --headers=hpp
