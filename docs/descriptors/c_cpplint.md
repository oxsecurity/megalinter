...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'hxx', 'h', 'hpp', 'cuh', 'c++', 'cu', 'cpp', 'hh', 'cc', 'c', 'h++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,hxx,h,hpp,cuh,c++,cu,cpp,hh,cc,c,h++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'h', 'hpp', 'cuh', 'hh', 'h++'} will be assumed to be headers)

      Examples:
        --headers=hxx,h,hpp,cuh,hh,h++
        --headers=hpp,hxx
        --headers=hpp
