...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cuh', 'hh', 'cpp', 'hpp', 'h++', 'cxx', 'h', 'hxx', 'c++', 'cc', 'cu', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cuh,hh,cpp,hpp,h++,cxx,h,hxx,c++,cc,cu,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'cuh', 'hh', 'hpp', 'h++', 'hxx', 'h'} will be assumed to be headers)

      Examples:
        --headers=cuh,hh,hpp,h++,hxx,h
        --headers=hpp,hxx
        --headers=hpp
