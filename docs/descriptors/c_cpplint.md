...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'cuh', 'hpp', 'cc', 'h', 'cpp', 'c++', 'cxx', 'h++', 'hxx', 'cu', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,cuh,hpp,cc,h,cpp,c++,cxx,h++,hxx,cu,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'cuh', 'hpp', 'h', 'h++', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=hh,cuh,hpp,h,h++,hxx
        --headers=hpp,hxx
        --headers=hpp
