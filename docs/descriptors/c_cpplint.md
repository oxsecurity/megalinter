...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hxx', 'cuh', 'h', 'cu', 'cxx', 'h++', 'cc', 'c', 'c++', 'hpp', 'cpp', 'hh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hxx,cuh,h,cu,cxx,h++,cc,c,c++,hpp,cpp,hh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'cuh', 'h', 'h++', 'hpp', 'hh'} will be assumed to be headers)

      Examples:
        --headers=hxx,cuh,h,h++,hpp,hh
        --headers=hpp,hxx
        --headers=hpp
