...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'h++', 'hxx', 'c', 'cxx', 'cc', 'hh', 'cuh', 'cu', 'hpp', 'h', 'c++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,h++,hxx,c,cxx,cc,hh,cuh,cu,hpp,h,c++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hxx', 'hh', 'cuh', 'hpp', 'h'} will be assumed to be headers)

      Examples:
        --headers=h++,hxx,hh,cuh,hpp,h
        --headers=hpp,hxx
        --headers=hpp
