...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'c++', 'cu', 'h', 'cuh', 'h++', 'hxx', 'c', 'cpp', 'hh', 'cc', 'cxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,c++,cu,h,cuh,h++,hxx,c,cpp,hh,cc,cxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'h', 'hxx', 'h++', 'cuh', 'hh'} will be assumed to be headers)

      Examples:
        --headers=hpp,h,hxx,h++,cuh,hh
        --headers=hpp,hxx
        --headers=hpp
