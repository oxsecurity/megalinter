...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'cc', 'cpp', 'h', 'cuh', 'hxx', 'cu', 'c++', 'c', 'cxx', 'hh', 'h++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,cc,cpp,h,cuh,hxx,cu,c++,c,cxx,hh,h++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'hxx', 'cuh', 'hh', 'h', 'h++'} will be assumed to be headers)

      Examples:
        --headers=hpp,hxx,cuh,hh,h,h++
        --headers=hpp,hxx
        --headers=hpp
