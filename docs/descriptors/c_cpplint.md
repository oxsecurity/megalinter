...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cc', 'hh', 'cuh', 'hxx', 'cpp', 'hpp', 'c', 'cxx', 'h++', 'h', 'c++', 'cu'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cc,hh,cuh,hxx,cpp,hpp,c,cxx,h++,h,c++,cu
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'cuh', 'hxx', 'hpp', 'h++', 'h'} will be assumed to be headers)

      Examples:
        --headers=hh,cuh,hxx,hpp,h++,h
        --headers=hpp,hxx
        --headers=hpp
