...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h++', 'hxx', 'cuh', 'c', 'hh', 'h', 'c++', 'cpp', 'hpp', 'cc', 'cu', 'cxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h++,hxx,cuh,c,hh,h,c++,cpp,hpp,cc,cu,cxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hxx', 'cuh', 'hh', 'h', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=h++,hxx,cuh,hh,h,hpp
        --headers=hpp,hxx
        --headers=hpp
