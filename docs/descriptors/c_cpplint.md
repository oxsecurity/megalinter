...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cpp', 'h++', 'cu', 'c', 'h', 'hxx', 'cxx', 'hpp', 'c++', 'hh', 'cc', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cpp,h++,cu,c,h,hxx,cxx,hpp,c++,hh,cc,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'h', 'hxx', 'hpp', 'hh', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=h++,h,hxx,hpp,hh,cuh
        --headers=hpp,hxx
        --headers=hpp
