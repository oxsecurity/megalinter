...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cuh', 'cu', 'c++', 'hpp', 'cxx', 'h', 'hxx', 'hh', 'cpp', 'c', 'h++', 'cc'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cuh,cu,c++,hpp,cxx,h,hxx,hh,cpp,c,h++,cc
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'cuh', 'hpp', 'h', 'hxx', 'hh', 'h++'} will be assumed to be headers)

      Examples:
        --headers=cuh,hpp,h,hxx,hh,h++
        --headers=hpp,hxx
        --headers=hpp
