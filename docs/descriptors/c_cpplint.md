...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['c++', 'cxx', 'cu', 'hh', 'cuh', 'hxx', 'hpp', 'h++', 'c', 'h', 'cc', 'cpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=c++,cxx,cu,hh,cuh,hxx,hpp,h++,c,h,cc,cpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'cuh', 'hxx', 'h++', 'hpp', 'h'} will be assumed to be headers)

      Examples:
        --headers=hh,cuh,hxx,h++,hpp,h
        --headers=hpp,hxx
        --headers=hpp
