...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hxx', 'hh', 'cuh', 'cu', 'hpp', 'h++', 'cc', 'cpp', 'h', 'cxx', 'c++', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hxx,hh,cuh,cu,hpp,h++,cc,cpp,h,cxx,c++,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'hh', 'cuh', 'hpp', 'h++', 'h'} will be assumed to be headers)

      Examples:
        --headers=hxx,hh,cuh,hpp,h++,h
        --headers=hpp,hxx
        --headers=hpp
