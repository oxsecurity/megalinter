...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cxx', 'c++', 'hpp', 'cpp', 'c', 'hxx', 'h++', 'cc', 'cu', 'h', 'hh', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cxx,c++,hpp,cpp,c,hxx,h++,cc,cu,h,hh,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'hxx', 'h++', 'h', 'hh', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hpp,hxx,h++,h,hh,cuh
        --headers=hpp,hxx
        --headers=hpp
