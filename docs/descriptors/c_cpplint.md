...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hh', 'cu', 'c++', 'cxx', 'hpp', 'h', 'cc', 'c', 'h++', 'cpp', 'cuh', 'hxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hh,cu,c++,cxx,hpp,h,cc,c,h++,cpp,cuh,hxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'hpp', 'h', 'h++', 'cuh', 'hxx'} will be assumed to be headers)

      Examples:
        --headers=hh,hpp,h,h++,cuh,hxx
        --headers=hpp,hxx
        --headers=hpp
