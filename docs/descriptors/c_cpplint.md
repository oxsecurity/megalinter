...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cc', 'hh', 'c++', 'cu', 'hxx', 'h', 'cxx', 'h++', 'cuh', 'c', 'cpp', 'hpp'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cc,hh,c++,cu,hxx,h,cxx,h++,cuh,c,cpp,hpp
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hh', 'h', 'hxx', 'h++', 'cuh', 'hpp'} will be assumed to be headers)

      Examples:
        --headers=hh,h,hxx,h++,cuh,hpp
        --headers=hpp,hxx
        --headers=hpp
