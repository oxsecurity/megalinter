...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h++', 'c', 'hxx', 'hh', 'hpp', 'cu', 'c++', 'cc', 'h', 'cpp', 'cuh', 'cxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h++,c,hxx,hh,hpp,cu,c++,cc,h,cpp,cuh,cxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hxx', 'hh', 'hpp', 'h', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=h++,hxx,hh,hpp,h,cuh
        --headers=hpp,hxx
        --headers=hpp
