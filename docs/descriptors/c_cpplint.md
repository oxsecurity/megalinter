...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h++', 'hpp', 'hxx', 'cxx', 'hh', 'h', 'cu', 'cc', 'c++', 'cpp', 'cuh', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h++,hpp,hxx,cxx,hh,h,cu,cc,c++,cpp,cuh,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hpp', 'hxx', 'hh', 'h', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=h++,hpp,hxx,hh,h,cuh
        --headers=hpp,hxx
        --headers=hpp
