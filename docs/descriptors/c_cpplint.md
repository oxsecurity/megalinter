...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cu', 'cuh', 'c', 'hxx', 'hpp', 'hh', 'h++', 'cc', 'cpp', 'cxx', 'h', 'c++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cu,cuh,c,hxx,hpp,hh,h++,cc,cpp,cxx,h,c++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'cuh', 'hxx', 'hpp', 'hh', 'h++', 'h'} will be assumed to be headers)

      Examples:
        --headers=cuh,hxx,hpp,hh,h++,h
        --headers=hpp,hxx
        --headers=hpp
