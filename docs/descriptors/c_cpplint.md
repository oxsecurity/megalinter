...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'hxx', 'hh', 'c', 'cuh', 'cu', 'h', 'cxx', 'cc', 'cpp', 'h++', 'c++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,hxx,hh,c,cuh,cu,h,cxx,cc,cpp,h++,c++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'hxx', 'hh', 'cuh', 'h', 'h++'} will be assumed to be headers)

      Examples:
        --headers=hpp,hxx,hh,cuh,h,h++
        --headers=hpp,hxx
        --headers=hpp
