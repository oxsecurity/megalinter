...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hxx', 'c', 'h', 'hpp', 'h++', 'cuh', 'cxx', 'cc', 'hh', 'cpp', 'cu', 'c++'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hxx,c,h,hpp,h++,cuh,cxx,cc,hh,cpp,cu,c++
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'h', 'hpp', 'h++', 'cuh', 'hh'} will be assumed to be headers)

      Examples:
        --headers=hxx,h,hpp,h++,cuh,hh
        --headers=hpp,hxx
        --headers=hpp
