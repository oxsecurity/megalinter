...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['cc', 'c++', 'cpp', 'cxx', 'h++', 'hh', 'hpp', 'cuh', 'hxx', 'h', 'cu', 'c'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=cc,c++,cpp,cxx,h++,hh,hpp,cuh,hxx,h,cu,c
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h++', 'hh', 'hpp', 'hxx', 'cuh', 'h'} will be assumed to be headers)

      Examples:
        --headers=h++,hh,hpp,hxx,cuh,h
        --headers=hpp,hxx
        --headers=hpp
