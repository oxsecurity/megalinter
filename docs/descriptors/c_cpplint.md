...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h', 'h++', 'hh', 'c++', 'hxx', 'cc', 'cpp', 'cxx', 'c', 'hpp', 'cu', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h,h++,hh,c++,hxx,cc,cpp,cxx,c,hpp,cu,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'h++', 'hh', 'hxx', 'hpp', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=h,h++,hh,hxx,hpp,cuh
        --headers=hpp,hxx
        --headers=hpp
