...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['h', 'hpp', 'cuh', 'cc', 'c++', 'hh', 'cpp', 'hxx', 'c', 'cu', 'h++', 'cxx'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=h,hpp,cuh,cc,c++,hh,cpp,hxx,c,cu,h++,cxx
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'hpp', 'cuh', 'hh', 'hxx', 'h++'} will be assumed to be headers)

      Examples:
        --headers=h,hpp,cuh,hh,hxx,h++
        --headers=hpp,hxx
        --headers=hpp
