...
| EDITORCONFIG_EDITORCONFIG_CHECKER_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with EDITORCONFIG_EDITORCONFIG_CHECKER_CLI_LINT_MODE = project 
| EDITORCONFIG_EDITORCONFIG_CHECKER_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with EDITORCONFIG_EDITORCONFIG_CHECKER_CLI_LINT_MODE = project 
