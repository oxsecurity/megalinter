...
| EDITORCONFIG_EDITORCONFIG_CHECKER_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling EDITORCONFIG_EDITORCONFIG_CHECKER and its pre/post commands                                                                                           | None                                            |
