...
| GROOVY_NPM_GROOVY_LINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling GROOVY_NPM_GROOVY_LINT and its pre/post commands                                                                                                      | None                                            |
