...
| GRAPHQL_GRAPHQL_SCHEMA_LINTER_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling GRAPHQL_GRAPHQL_SCHEMA_LINTER and its pre/post commands                                                                        | None                                            |
