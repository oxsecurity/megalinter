...
- Enable robocop by adding `ROBOTFRAMEWORK_ROBOCOP` in [ENABLE_LINTERS variable](https://megalinter.io/10.1.0/configuration/#activation-and-deactivation)
- Disable robocop by adding `ROBOTFRAMEWORK_ROBOCOP` in [DISABLE_LINTERS variable](https://megalinter.io/10.1.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `ROBOTFRAMEWORK_ROBOCOP` in [APPLY_FIXES variable](https://megalinter.io/10.1.0/configuration/#apply-fixes)
...
| ROBOTFRAMEWORK_ROBOCOP_FORWARD_EXCLUDED_DIRECTORIES | In project CLI lint mode, forward excluded directories (EXCLUDED_DIRECTORIES + ADDITIONAL_EXCLUDED_DIRECTORIES) to the linter through its native exclusion arguments or generated ignore/config files               | `true`                                          |
...
│ list     List available rules, reports, formatters or plugins.               │
...
│ config   Manage Robocop configuration files.                                 │
╰──────────────────────────────────────────────────────────────────────────────╯
...
- PIP packages (Python):
  - [robotframework-robocop==9.0.0](https://pypi.org/project/robotframework-robocop/9.0.0)
