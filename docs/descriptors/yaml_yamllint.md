...
- See [How to configure yamllint rules](https://yamllint.readthedocs.io/en/stable/configuration.html#configuration){target=_blank}
  - If custom `.yamllint.yml` config file is not found, [.yamllint.yml](https://github.com/megalinter/megalinter/tree/master/TEMPLATES/.yamllint.yml){target=_blank} will be used
...
|:----------------------------------------------------------------------------------------------------------------------------------------------:|----------------------------------------------|-------------------------------------------------------------------|:--------------------------------------------------------------------------------------:|
| <img src="https://github.com/megalinter/megalinter/raw/master/docs/assets/icons/emacs.ico" alt="" height="32px" class="megalinter-icon"></a> | [Emacs](https://www.gnu.org/software/emacs/) | [flycheck](https://github.com/krzysztof-magosa/flycheck-yamllint) | [Visit Web Site](https://github.com/krzysztof-magosa/flycheck-yamllint){target=_blank} |
