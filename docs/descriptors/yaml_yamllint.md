...
- Enable yamllint by adding `YAML_YAMLLINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.22.2/configuration/#activation-and-deactivation)
- Disable yamllint by adding `YAML_YAMLLINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.22.2/configuration/#activation-and-deactivation)
