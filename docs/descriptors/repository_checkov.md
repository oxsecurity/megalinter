...
- Enable checkov by adding `REPOSITORY_CHECKOV` in [ENABLE_LINTERS variable](https://megalinter.io/9.2.0/configuration/#activation-and-deactivation)
- Disable checkov by adding `REPOSITORY_CHECKOV` in [DISABLE_LINTERS variable](https://megalinter.io/9.2.0/configuration/#activation-and-deactivation)
...
- PIP packages (Python):
  - [checkov==3.2.495](https://pypi.org/project/checkov/3.2.495)
