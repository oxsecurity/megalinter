...
- Enable checkov by adding `REPOSITORY_CHECKOV` in [ENABLE_LINTERS variable](https://megalinter.io/8.5.0/configuration/#activation-and-deactivation)
- Disable checkov by adding `REPOSITORY_CHECKOV` in [DISABLE_LINTERS variable](https://megalinter.io/8.5.0/configuration/#activation-and-deactivation)
...
ARG PIP_CHECKOV_VERSION=3.2.390
```

- PIP packages (Python):
  - [checkov==3.2.390](https://pypi.org/project/checkov/3.2.390)
