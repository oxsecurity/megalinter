...
- Enable checkov by adding `REPOSITORY_CHECKOV` in [ENABLE_LINTERS variable](https://megalinter.io/7.1.0/configuration/#activation-and-deactivation)
- Disable checkov by adding `REPOSITORY_CHECKOV` in [DISABLE_LINTERS variable](https://megalinter.io/7.1.0/configuration/#activation-and-deactivation)
