...
| SALESFORCE_SFDX_SCANNER_AURA_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling SALESFORCE_SFDX_SCANNER_AURA and its pre/post commands | None                                            |
