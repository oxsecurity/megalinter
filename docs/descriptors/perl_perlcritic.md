...
- Enable perlcritic by adding `PERL_PERLCRITIC` in [ENABLE_LINTERS variable](https://megalinter.io/7.2.0/configuration/#activation-and-deactivation)
- Disable perlcritic by adding `PERL_PERLCRITIC` in [DISABLE_LINTERS variable](https://megalinter.io/7.2.0/configuration/#activation-and-deactivation)
