...
| PUPPET_PUPPET_LINT_FILTER_REGEX_INCLUDE        | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with PUPPET_PUPPET_LINT_CLI_LINT_MODE = project                                                                                             | Exclude no file                                 |
| PUPPET_PUPPET_LINT_FILTER_REGEX_EXCLUDE        | Custom regex excluding filter<br/>Ex: `(test\|examples)`<br/>⚠️ Not available with PUPPET_PUPPET_LINT_CLI_LINT_MODE = project                                                                                       | Exclude no file                                 |
