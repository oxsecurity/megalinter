...
| PUPPET_PUPPET_LINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling PUPPET_PUPPET_LINT and its pre/post commands                                                                                   | None                                            |
