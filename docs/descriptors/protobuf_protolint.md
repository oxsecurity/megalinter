...
- Enable protolint by adding `PROTOBUF_PROTOLINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.11.0/configuration/#activation-and-deactivation)
- Disable protolint by adding `PROTOBUF_PROTOLINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.11.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `PROTOBUF_PROTOLINT` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.11.0/configuration/#apply-fixes)
