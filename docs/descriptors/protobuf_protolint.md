...
- Enable protolint by adding `PROTOBUF_PROTOLINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.20.0/configuration/#activation-and-deactivation)
- Disable protolint by adding `PROTOBUF_PROTOLINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.20.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `PROTOBUF_PROTOLINT` in [APPLY_FIXES variable](https://megalinter.io/6.20.0/configuration/#apply-fixes)
