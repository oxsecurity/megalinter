...
| PROTOBUF_PROTOLINT_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with PROTOBUF_PROTOLINT_CLI_LINT_MODE = project
| PROTOBUF_PROTOLINT_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with PROTOBUF_PROTOLINT_CLI_LINT_MODE = project
