...
- Enable trivy by adding `REPOSITORY_TRIVY` in [ENABLE_LINTERS variable](https://megalinter.io/7.10.0/configuration/#activation-and-deactivation)
- Disable trivy by adding `REPOSITORY_TRIVY` in [DISABLE_LINTERS variable](https://megalinter.io/7.10.0/configuration/#activation-and-deactivation)
