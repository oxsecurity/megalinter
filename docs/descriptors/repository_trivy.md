...
| REPOSITORY_TRIVY_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling REPOSITORY_TRIVY and its pre/post commands | None                                            |
