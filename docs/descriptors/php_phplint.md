...
- Enable phplint by adding `PHP_PHPLINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
- Disable phplint by adding `PHP_PHPLINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.22.0/configuration/#activation-and-deactivation)
