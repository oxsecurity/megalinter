...
| CLOJURE_CLJ_KONDO_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with CLOJURE_CLJ_KONDO_CLI_LINT_MODE = project 
| CLOJURE_CLJ_KONDO_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with CLOJURE_CLJ_KONDO_CLI_LINT_MODE = project 
