...
- Version in MegaLinter: **2023.05.18**
...
| CLOJURE_CLJ_KONDO_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling CLOJURE_CLJ_KONDO and its pre/post commands                                                                                    | None                                            |
...
Options:
  ...
  --config <config>: config may be a file or an EDN expression. See
    https://cljdoc.org/d/clj-kondo/clj-kondo/2023.05.18/doc/configuration
