...
description: pylint, black, flake8, isort, bandit, mypy, pyright, ruff, ruff-format are available to analyze PYTHON files in MegaLinter
---
...
| [**pyright**](python_pyright.md)<br/>[_PYTHON_PYRIGHT_](python_pyright.md)                 | ![disabled](https://shields.io/badge/-disabled-orange) [![GitHub stars](https://img.shields.io/github/stars/microsoft/pyright?cacheSeconds=3600)](https://github.com/microsoft/pyright)                                         |
...
| [**ruff-format**](python_ruff_format.md)<br/>[_PYTHON_RUFF_FORMAT_](python_ruff_format.md) | [![GitHub stars](https://img.shields.io/github/stars/astral-sh/ruff?cacheSeconds=3600)](https://github.com/astral-sh/ruff) ![formatter](https://shields.io/badge/-format-yellow)                                                |
