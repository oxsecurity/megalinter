...
| POWERSHELL_POWERSHELL_FORMATTER_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling POWERSHELL_POWERSHELL_FORMATTER and its pre/post commands                                                                      | None                                                                |
