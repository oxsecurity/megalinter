...
- Enable powershell_formatter by adding `POWERSHELL_POWERSHELL_FORMATTER` in [ENABLE_LINTERS variable](https://megalinter.io/8.4.0/configuration/#activation-and-deactivation)
- Disable powershell_formatter by adding `POWERSHELL_POWERSHELL_FORMATTER` in [DISABLE_LINTERS variable](https://megalinter.io/8.4.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `POWERSHELL_POWERSHELL_FORMATTER` in [APPLY_FIXES variable](https://megalinter.io/8.4.0/configuration/#apply-fixes)
