...
- Enable eslint by adding `JSX_ESLINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.9.0/configuration/#activation-and-deactivation)
- Disable eslint by adding `JSX_ESLINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.9.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `JSX_ESLINT` in [APPLY_FIXES variable](https://megalinter.io/7.9.0/configuration/#apply-fixes)
