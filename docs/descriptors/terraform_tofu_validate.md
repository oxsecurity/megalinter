...
- Enable tofu-validate by adding `TERRAFORM_TOFU_VALIDATE` in [ENABLE_LINTERS variable](https://megalinter.io/beta/configuration/#activation-and-deactivation)
- Disable tofu-validate by adding `TERRAFORM_TOFU_VALIDATE` in [DISABLE_LINTERS variable](https://megalinter.io/beta/configuration/#activation-and-deactivation)
