...
- Enable markdownlint by adding `MARKDOWN_MARKDOWNLINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.0.1/configuration/#activation-and-deactivation)
- Disable markdownlint by adding `MARKDOWN_MARKDOWNLINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.0.1/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `MARKDOWN_MARKDOWNLINT` in [APPLY_FIXES variable](https://megalinter.io/9.0.1/configuration/#apply-fixes)
