...
- Enable markdownlint by adding `MARKDOWN_MARKDOWNLINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#activation-and-deactivation)
- Disable markdownlint by adding `MARKDOWN_MARKDOWNLINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `MARKDOWN_MARKDOWNLINT` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#apply-fixes)
