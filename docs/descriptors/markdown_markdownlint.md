...
| MARKDOWN_MARKDOWNLINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling MARKDOWN_MARKDOWNLINT and its pre/post commands                                                                                                       | None                                            |
