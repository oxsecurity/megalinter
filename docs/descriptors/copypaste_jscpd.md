...
- See [How to configure jscpd rules](https://github.com/kucherenko/jscpd/tree/master/packages/jscpd#config-file){target=_blank}
  - If custom `.jscpd.json` config file is not found, [.jscpd.json](https://github.com/mega-linter/mega-linter/tree/master/TEMPLATES/.jscpd.json){target=_blank} will be used
...
- Enable jscpd by adding `COPYPASTE_JSCPD` in [ENABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
- Disable jscpd by adding `COPYPASTE_JSCPD` in [DISABLE_LINTERS variable](https://mega-linter.github.io/configuration/#activation-and-deactivation)
...
See documentation on https://mega-linter.github.io/descriptors/copypaste_jscpd/
-----------------------------------------------
