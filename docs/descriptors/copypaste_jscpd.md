...
- See [How to configure jscpd rules](https://github.com/kucherenko/jscpd/tree/master/packages/jscpd#config-file){target=_blank}
  - If custom `.jscpd.json` config file is not found, [.jscpd.json](https://github.com/megalinter/megalinter/tree/master/TEMPLATES/.jscpd.json){target=_blank} will be used
