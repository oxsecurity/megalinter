...
| CLOJURE_CLJSTYLE_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling CLOJURE_CLJSTYLE and its pre/post commands                                                                                     | None                                            |
