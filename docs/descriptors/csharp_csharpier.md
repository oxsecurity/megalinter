...
| CSHARP_CSHARPIER_FILE_EXTENSIONS             | Allowed file extensions. `"*"` matches any extension, `""` matches empty extension. Empty list excludes all files<br/>Ex: `[".py", ""]`                                                                             | `[".config", ".cs", ".csproj", ".props", ".targets", ".xml"]` |
...
- File extensions: `.config`, `.cs`, `.csproj`, `.props`, `.targets`, `.xml`
