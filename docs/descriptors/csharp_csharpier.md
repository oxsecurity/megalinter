...
| CSHARP_CSHARPIER_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling CSHARP_CSHARPIER and its pre/post commands                                                                                                            | None               |
