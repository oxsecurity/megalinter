...
- Enable pylint by adding `PYTHON_PYLINT` in [ENABLE_LINTERS variable](https://megalinter.io/6.20.0/configuration/#activation-and-deactivation)
- Disable pylint by adding `PYTHON_PYLINT` in [DISABLE_LINTERS variable](https://megalinter.io/6.20.0/configuration/#activation-and-deactivation)
