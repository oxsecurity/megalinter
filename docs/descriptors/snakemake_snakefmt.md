...
| SNAKEMAKE_SNAKEFMT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling SNAKEMAKE_SNAKEFMT and its pre/post commands                                                                                   | None                                            |
