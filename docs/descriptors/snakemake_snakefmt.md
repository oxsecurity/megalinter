...
- Enable snakefmt by adding `SNAKEMAKE_SNAKEFMT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#activation-and-deactivation)
- Disable snakefmt by adding `SNAKEMAKE_SNAKEFMT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `SNAKEMAKE_SNAKEFMT` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.6.0/configuration/#apply-fixes)
