...
description: jsonlint, v8r, prettier, npm-package-json-lint, biome are available to analyze JSON files in MegaLinter
---
...
| [**biome**](json_biome.md)<br/>[_JSON_BIOME_](json_biome.md)                                                                 | [![GitHub stars](https://img.shields.io/github/stars/biomejs/biome?cacheSeconds=3600)](https://github.com/biomejs/biome) ![autofix](https://shields.io/badge/-autofix-green) ![sarif](https://shields.io/badge/-SARIF-orange) |
