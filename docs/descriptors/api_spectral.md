...
- Enable spectral by adding `API_SPECTRAL` in [ENABLE_LINTERS variable](https://megalinter.io/8.2.0/configuration/#activation-and-deactivation)
- Disable spectral by adding `API_SPECTRAL` in [DISABLE_LINTERS variable](https://megalinter.io/8.2.0/configuration/#activation-and-deactivation)
