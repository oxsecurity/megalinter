...
- Enable eslint-plugin-jsonc by adding `JSON_ESLINT_PLUGIN_JSONC` in [ENABLE_LINTERS variable](https://megalinter.io/7.0.0/configuration/#activation-and-deactivation)
- Disable eslint-plugin-jsonc by adding `JSON_ESLINT_PLUGIN_JSONC` in [DISABLE_LINTERS variable](https://megalinter.io/7.0.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `JSON_ESLINT_PLUGIN_JSONC` in [APPLY_FIXES variable](https://megalinter.io/7.0.0/configuration/#apply-fixes)
