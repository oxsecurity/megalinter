...
- Enable eslint-plugin-jsonc by adding `JSON_ESLINT_PLUGIN_JSONC` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.10.0/configuration/#activation-and-deactivation)
- Disable eslint-plugin-jsonc by adding `JSON_ESLINT_PLUGIN_JSONC` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.10.0/configuration/#activation-and-deactivation)

- Enable **auto-fixes** by adding `JSON_ESLINT_PLUGIN_JSONC` in [APPLY_FIXES variable](https://oxsecurity.github.io/megalinter/6.10.0/configuration/#apply-fixes)
