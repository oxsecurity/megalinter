...
| JSON_ESLINT_PLUGIN_JSONC_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling JSON_ESLINT_PLUGIN_JSONC and its pre/post commands                                                                                                    | None                                            |
