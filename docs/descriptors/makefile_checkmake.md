...
| MAKEFILE_CHECKMAKE_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling MAKEFILE_CHECKMAKE and its pre/post commands                                                                                   | None                                            |
