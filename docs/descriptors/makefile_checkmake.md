...
- Enable checkmake by adding `MAKEFILE_CHECKMAKE` in [ENABLE_LINTERS variable](https://megalinter.io/7.13.0/configuration/#activation-and-deactivation)
- Disable checkmake by adding `MAKEFILE_CHECKMAKE` in [DISABLE_LINTERS variable](https://megalinter.io/7.13.0/configuration/#activation-and-deactivation)
