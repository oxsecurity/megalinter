...
| BICEP_BICEP_LINTER_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling BICEP_BICEP_LINTER and its pre/post commands                                                                                   | None               |
