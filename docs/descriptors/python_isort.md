...
- Enable isort by adding `PYTHON_ISORT` in [ENABLE_LINTERS variable](https://megalinter.io/7.4.0/configuration/#activation-and-deactivation)
- Disable isort by adding `PYTHON_ISORT` in [DISABLE_LINTERS variable](https://megalinter.io/7.4.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `PYTHON_ISORT` in [APPLY_FIXES variable](https://megalinter.io/7.4.0/configuration/#apply-fixes)
