...
- Enable shellcheck by adding `BASH_SHELLCHECK` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.11.1/configuration/#activation-and-deactivation)
- Disable shellcheck by adding `BASH_SHELLCHECK` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.11.1/configuration/#activation-and-deactivation)
