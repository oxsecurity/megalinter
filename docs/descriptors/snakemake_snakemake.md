...
- Enable snakemake by adding `SNAKEMAKE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/8.8.0/configuration/#activation-and-deactivation)
- Disable snakemake by adding `SNAKEMAKE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/8.8.0/configuration/#activation-and-deactivation)
...
usage: snakemake [-h] [--dry-run] [--profile PROFILE]
                 ...
                 [--scheduler [{ilp,greedy}]] [--wms-monitor [WMS_MONITOR]]
