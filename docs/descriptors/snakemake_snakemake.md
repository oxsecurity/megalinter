...
- Enable snakemake by adding `SNAKEMAKE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.10.0/configuration/#activation-and-deactivation)
- Disable snakemake by adding `SNAKEMAKE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.10.0/configuration/#activation-and-deactivation)
...
EXECUTION:
  ...
  --rerun-triggers {code,input,mtime,params,software-env} [{code,input,mtime,params,software-env} ...]
                        ...
                        3>, <RerunTrigger.PARAMS: 1>, <RerunTrigger.INPUT:
                        2>}))
...
REMOTE EXECUTION:
  --container-image IMAGE
                        ...
                        running version. (default: snakemake/snakemake:v8.5.5)
  --immediate-submit, --is
...
html executor settings:
  --report-html-path VALUE
                        ...
                        <dataclasses._MISSING_TYPE object at 0x7f574fa99490>)
  --report-html-stylesheet-path VALUE
