...
- Enable snakemake by adding `SNAKEMAKE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.11.0/configuration/#activation-and-deactivation)
- Disable snakemake by adding `SNAKEMAKE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.11.0/configuration/#activation-and-deactivation)
...
html executor settings:
  --report-html-path VALUE
                        ...
                        <dataclasses._MISSING_TYPE object at 0x7f9f9af09d00>)
  --report-html-stylesheet-path VALUE
