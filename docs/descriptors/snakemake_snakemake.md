...
- Enable snakemake by adding `SNAKEMAKE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.1.0/configuration/#activation-and-deactivation)
- Disable snakemake by adding `SNAKEMAKE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.1.0/configuration/#activation-and-deactivation)
...
ARG PIP_SNAKEMAKE_VERSION=9.11.9
```

- PIP packages (Python):
  - [snakemake==9.11.9](https://pypi.org/project/snakemake/9.11.9)
