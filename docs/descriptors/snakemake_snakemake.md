...
- Enable snakemake by adding `SNAKEMAKE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.11.1/configuration/#activation-and-deactivation)
- Disable snakemake by adding `SNAKEMAKE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.11.1/configuration/#activation-and-deactivation)
...
EXECUTION:
  ...
  --rerun-triggers {code,input,mtime,params,software-env} [{code,input,mtime,params,software-env} ...]
                        ...
                        1>, <RerunTrigger.CODE: 4>, <RerunTrigger.MTIME: 0>}))
...
html executor settings:
  --report-html-path VALUE
                        ...
                        <dataclasses._MISSING_TYPE object at 0x7fc911ba9d60>)
  --report-html-stylesheet-path VALUE
