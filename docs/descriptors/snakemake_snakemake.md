...
- Enable snakemake by adding `SNAKEMAKE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/7.12.0/configuration/#activation-and-deactivation)
- Disable snakemake by adding `SNAKEMAKE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/7.12.0/configuration/#activation-and-deactivation)
...
EXECUTION:
  ...
  --rerun-triggers {code,input,mtime,params,software-env} [{code,input,mtime,params,software-env} ...]
                        ...
                        3>, <RerunTrigger.MTIME: 0>, <RerunTrigger.PARAMS:
                        1>}))
...
html executor settings:
  --report-html-path VALUE
                        ...
                        <dataclasses._MISSING_TYPE object at 0x7fdff81fde80>)
  --report-html-stylesheet-path VALUE
