...
- Enable secretlint by adding `REPOSITORY_SECRETLINT` in [ENABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.0/configuration/#activation-and-deactivation)
- Disable secretlint by adding `REPOSITORY_SECRETLINT` in [DISABLE_LINTERS variable](https://oxsecurity.github.io/megalinter/6.9.0/configuration/#activation-and-deactivation)
