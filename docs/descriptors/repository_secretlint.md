...
- NPM packages (node.js):
  - [secretlint@10.2.0](https://www.npmjs.com/package/secretlint/v/10.2.0)
  - [@secretlint/secretlint-rule-preset-recommend@10.2.0](https://www.npmjs.com/package/@secretlint/secretlint-rule-preset-recommend/v/10.2.0)
  - [@secretlint/secretlint-formatter-sarif@10.2.0](https://www.npmjs.com/package/@secretlint/secretlint-formatter-sarif/v/10.2.0)
