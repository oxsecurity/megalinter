...
- NPM packages (node.js):
  - [secretlint@9.3.3](https://www.npmjs.com/package/secretlint/v/9.3.3)
  - [@secretlint/secretlint-rule-preset-recommend@9.3.3](https://www.npmjs.com/package/@secretlint/secretlint-rule-preset-recommend/v/9.3.3)
  - [@secretlint/secretlint-formatter-sarif@9.3.3](https://www.npmjs.com/package/@secretlint/secretlint-formatter-sarif/v/9.3.3)
