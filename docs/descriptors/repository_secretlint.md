...
- NPM packages (node.js):
  - [secretlint@11.2.3](https://www.npmjs.com/package/secretlint/v/11.2.3)
  - [@secretlint/secretlint-rule-preset-recommend@11.2.3](https://www.npmjs.com/package/@secretlint/secretlint-rule-preset-recommend/v/11.2.3)
  - [@secretlint/secretlint-formatter-sarif@11.2.3](https://www.npmjs.com/package/@secretlint/secretlint-formatter-sarif/v/11.2.3)
