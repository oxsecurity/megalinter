...
| REPOSITORY_SECRETLINT_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling REPOSITORY_SECRETLINT and its pre/post commands | None                                            |
