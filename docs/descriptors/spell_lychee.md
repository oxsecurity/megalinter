...
- Enable lychee by adding `SPELL_LYCHEE` in [ENABLE_LINTERS variable](https://megalinter.io/7.7.0/configuration/#activation-and-deactivation)
- Disable lychee by adding `SPELL_LYCHEE` in [DISABLE_LINTERS variable](https://megalinter.io/7.7.0/configuration/#activation-and-deactivation)
