...
- Enable helm by adding `KUBERNETES_HELM` in [ENABLE_LINTERS variable](https://megalinter.io/7.1.0/configuration/#activation-and-deactivation)
- Disable helm by adding `KUBERNETES_HELM` in [DISABLE_LINTERS variable](https://megalinter.io/7.1.0/configuration/#activation-and-deactivation)
