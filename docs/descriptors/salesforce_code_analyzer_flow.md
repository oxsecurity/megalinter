...
- Enable code-analyzer-flow by adding `SALESFORCE_CODE_ANALYZER_FLOW` in [ENABLE_LINTERS variable](https://megalinter.io/10.1.0/configuration/#activation-and-deactivation)
- Disable code-analyzer-flow by adding `SALESFORCE_CODE_ANALYZER_FLOW` in [DISABLE_LINTERS variable](https://megalinter.io/10.1.0/configuration/#activation-and-deactivation)
...
Streaming logs in real time to:
    /tmp/sfca-2026_09_05_10_08_19_116.log
