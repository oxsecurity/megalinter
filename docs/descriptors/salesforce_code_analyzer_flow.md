...
- Enable code-analyzer-flow by adding `SALESFORCE_CODE_ANALYZER_FLOW` in [ENABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
- Disable code-analyzer-flow by adding `SALESFORCE_CODE_ANALYZER_FLOW` in [DISABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
...
Streaming logs in real time to:
    /tmp/sfca-2026_08_08_08_34_51_752.log
