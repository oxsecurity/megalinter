...
- Enable gitleaks by adding `REPOSITORY_GITLEAKS` in [ENABLE_LINTERS variable](https://megalinter.io/8.8.0/configuration/#activation-and-deactivation)
- Disable gitleaks by adding `REPOSITORY_GITLEAKS` in [DISABLE_LINTERS variable](https://megalinter.io/8.8.0/configuration/#activation-and-deactivation)
...
Flags:
  ...
  -c, --config string                 config file path
      ...
      --experimental-optimizations    enables experimental allowlist optimizations, increasing performance at the cost of startup time
