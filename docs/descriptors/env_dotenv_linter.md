...
| ENV_DOTENV_LINTER_FILTER_REGEX_INCLUDE | Custom regex including filter<br/>Ex: `(src\|lib)`<br/>⚠️ Not available with ENV_DOTENV_LINTER_CLI_LINT_MODE = project
| ENV_DOTENV_LINTER_FILTER_REGEX_EXCLUDE | Custom regex excluding filter<br/>Ex: `(test\|examples)` <br/>⚠️ Not available with ENV_DOTENV_LINTER_CLI_LINT_MODE = project
