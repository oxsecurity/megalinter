...
| ENV_DOTENV_LINTER_UNSECURED_ENV_VARIABLES     | List of env variables explicitely not filtered before calling ENV_DOTENV_LINTER and its pre/post commands                                                                                    | None                |
