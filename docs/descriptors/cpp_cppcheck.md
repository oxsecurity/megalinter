...
- Enable cppcheck by adding `CPP_CPPCHECK` in [ENABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
- Disable cppcheck by adding `CPP_CPPCHECK` in [DISABLE_LINTERS variable](https://megalinter.io/10.0.0/configuration/#activation-and-deactivation)
