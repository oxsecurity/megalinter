...
3. Make your change
4. Push and [submit a pull request][pr] (**IMPORTANT:** target **nvuillam/mega-linter** , branch **master_megalinter** , not the github/super-linter repository)
...
5. Push to your fork and [submit a pull request][pr] (**IMPORTANT:** target **nvuillam/mega-linter** , branch **master_megalinter** , not the github/super-linter repository)
