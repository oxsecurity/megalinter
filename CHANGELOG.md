...
- Linter versions upgrades (N)
  ...
  - [stylelint](https://stylelint.io) from 16.21.1 to **16.22.0** on 2025-07-18
  - [npm-package-json-lint](https://npmpackagejsonlint.org/) from 8.0.0 to **9.0.0** on 2025-07-18
  - [ruff-format](https://github.com/astral-sh/ruff) from 0.12.3 to **0.12.4** on 2025-07-18
  - [ruff](https://github.com/astral-sh/ruff) from 0.12.3 to **0.12.4** on 2025-07-18
<!-- linter-versions-end -->
