...
- Linter versions upgrades
  ...
  - [cfn-lint](https://github.com/aws-cloudformation/cfn-lint) from 1.12.1 to **1.12.3** on 2024-09-05
  - [phpstan](https://phpstan.org/) from 1.12.1 to **1.12** on 2024-09-05
  - [pyright](https://github.com/Microsoft/pyright) from 1.1.378 to **1.1.379** on 2024-09-05
  - [ruff](https://github.com/astral-sh/ruff) from 0.6.3 to **0.6.4** on 2024-09-05
  - [checkov](https://www.checkov.io/) from 3.2.242 to **3.2.246** on 2024-09-05
  - [trivy-sbom](https://aquasecurity.github.io/trivy/) from 0.54.1 to **0.55.0** on 2024-09-05
  - [trivy](https://aquasecurity.github.io/trivy/) from 0.54.1 to **0.55.0** on 2024-09-05
  - [rubocop](https://rubocop.org/) from 1.66.0 to **1.66.1** on 2024-09-05
  - [clippy](https://github.com/rust-lang/rust-clippy) from 0.1.80 to **0.1.81** on 2024-09-05
  - [snakemake](https://snakemake.readthedocs.io/en/stable/) from 8.19.0 to **8.19.3** on 2024-09-05
<!-- linter-versions-end -->
