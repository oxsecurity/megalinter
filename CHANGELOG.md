...
- Linter versions upgrades (N)
  ...
  - [phpstan](https://phpstan.org/) from 2.1.29 to **2.1.30** on 2025-10-04
  - [pyright](https://github.com/Microsoft/pyright) from 1.1.405 to **1.1.406** on 2025-10-04
  - [ruff-format](https://github.com/astral-sh/ruff) from 0.13.2 to **0.13.3** on 2025-10-04
  - [ruff](https://github.com/astral-sh/ruff) from 0.13.2 to **0.13.3** on 2025-10-04
  - [robocop](https://github.com/MarketSquare/robotframework-robocop) from 6.7.1 to **6.7.2** on 2025-10-04
<!-- linter-versions-end -->
