...
- Linter versions upgrades (N)
  ...
  - [checkstyle](https://checkstyle.org/) from 10.26.1 to **11.0.0** on 2025-08-08
  - [grype](https://github.com/anchore/grype) from 0.97.1 to **0.97.2** on 2025-08-08
  - [syft](https://github.com/anchore/syft) from 1.29.1 to **1.30.0** on 2025-08-08
  - [clippy](https://github.com/rust-lang/rust-clippy) from 0.1.88 to **0.1.89** on 2025-08-08
<!-- linter-versions-end -->
