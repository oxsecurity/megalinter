...
- Linter versions upgrades (N)
  ...
  - [cfn-lint](https://github.com/aws-cloudformation/cfn-lint) from 1.45.0 to **1.46.0** on 2026-03-08
  - [rumdl](https://github.com/rvben/rumdl) from 0.1.33 to **0.1.42** on 2026-03-08
  - [black](https://black.readthedocs.io/en/stable/) from 26.1.0 to **26.3.0** on 2026-03-08
  - [clippy](https://github.com/rust-lang/rust-clippy) from 0.1.93 to **0.1.94** on 2026-03-08
<!-- linter-versions-end -->
