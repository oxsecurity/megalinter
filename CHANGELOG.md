...
- Linter versions upgrades
  ...
  - [stylelint](https://stylelint.io) from 16.2.1 to **16.3.1** on 2024-03-27
  - [npm-groovy-lint](https://nvuillam.github.io/npm-groovy-lint/) from 14.2.4 to **14.3.0** on 2024-03-27
  - [pyright](https://github.com/Microsoft/pyright) from 1.1.355 to **1.1.356** on 2024-03-27
  - [checkov](https://www.checkov.io/) from 3.2.43 to **3.2.48** on 2024-03-27
  - [syft](https://github.com/anchore/syft) from 1.0.1 to **1.1.0** on 2024-03-27
  - [trivy-sbom](https://aquasecurity.github.io/trivy/) from 0.50.0 to **0.50.1** on 2024-03-27
  - [trivy](https://aquasecurity.github.io/trivy/) from 0.50.0 to **0.50.1** on 2024-03-27
  - [trufflehog](https://github.com/trufflesecurity/trufflehog) from 3.71.0 to **3.71.1** on 2024-03-27
  - [sfdx-scanner-apex](https://forcedotcom.github.io/sfdx-scanner/) from 3.22.0 to **3.23.0** on 2024-03-27
  - [sfdx-scanner-aura](https://forcedotcom.github.io/sfdx-scanner/) from 3.22.0 to **3.23.0** on 2024-03-27
  - [sfdx-scanner-lwc](https://forcedotcom.github.io/sfdx-scanner/) from 3.22.0 to **3.23.0** on 2024-03-27
  - [snakemake](https://snakemake.readthedocs.io/en/stable/) from 8.10.0 to **8.10.4** on 2024-03-27
  - [cspell](https://github.com/streetsidesoftware/cspell/tree/master/packages/cspell) from 8.6.0 to **8.6.1** on 2024-03-27
  - [terragrunt](https://terragrunt.gruntwork.io) from 0.55.16 to **0.55.19** on 2024-03-27
<!-- linter-versions-end -->
