...
class GithubStatusReporter(Reporter):
    ...
    def manage_activation(self):
        ...
        if config.exists(self.master.request_id,"MULTI_STATUS") and config.get(self.master.request_id,"MULTI_STATUS") == "true":
            self.is_active = True
        elif config.get(self.master.request_id,"GITHUB_STATUS_REPORTER", "false") != "false":
            self.is_active = True
