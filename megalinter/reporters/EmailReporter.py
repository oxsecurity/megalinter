...
class EmailReporter(Reporter):
    ...
    def manage_activation(self):
        ...
        elif config.get(self.master.request_id,"EMAIL_REPORTER_EMAIL", "none") == "none":
            logging.info(
    ...
    def produce_report(self):
        ...
        if (
            ...
            and config.get(self.master.request_id,"EMAIL_REPORTER_SEND_SUCCESS", "false") == "true"
        ...
        smtp_host = config.get(self.master.request_id,"EMAIL_REPORTER_SMTP_HOST", "smtp.gmail.com")
        ...
        sender = config.get(self.master.request_id,"EMAIL_REPORTER_SENDER", "megalinter@gmail.com")
        smtp_username = config.get(self.master.request_id,"EMAIL_REPORTER_SMTP_USERNAME", sender)
        smtp_password = config.get(self.master.request_id,"EMAIL_REPORTER_SMTP_PASSWORD", "")
