...
def display_header(mega_linter):
    ...
    if config.get(None, "GITHUB_REPOSITORY", "") != "":
        ...
        if config.exists(None, "PAT"):
            logging.warning("You should not use PAT anymore, please use Github Permissions in your Github Actions job")
            logging.warning("Add permissions contents:write, issues: write and pull-requests: write")
            logging.warning("More details: https://docs.github.com/en/actions/using-jobs/assigning-permissions-to-jobs")
