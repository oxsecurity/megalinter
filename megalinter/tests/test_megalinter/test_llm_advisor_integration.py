...
class TestLLMAdvisorIntegration(unittest.TestCase):
    ...
    @patch('megalinter.llm_provider.llm_provider_factory.LLMProviderFactory.create_provider')
    ...
    def test_ai_suggestions_with_linter_output(self, mock_create_provider, mock_config):
        ...
        mock_provider.get_default_model.return_value = "gpt-3.5-turbo"
        mock_provider.is_available.return_value = True
        mock_provider.invoke.return_value = "Remove the unused import statement to clean up your code"
        mock_create_provider.return_value = mock_provider
...
script.js:8:1: no-undef 'console' is not defined"""
    ...
    @patch('megalinter.config.get')
    @patch('megalinter.llm_provider.llm_provider_factory.LLMProviderFactory.create_provider')
    def test_prompt_building_with_various_linter_outputs(self, mock_create_provider, mock_config):
        ...
        test_cases = [
            ("pylint", "module.py:1:0: C0111: Missing module docstring (missing-docstring)"),
            ("flake8", "test.py:10:5: F401 'os' imported but unused"),
            ("eslint", "file.js:15:1: error no-unused-vars 'variable' is defined but never used"),
        ]
