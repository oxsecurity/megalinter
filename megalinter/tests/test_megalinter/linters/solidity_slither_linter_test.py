# !/usr/bin/env python3
"""
Unit tests for SOLIDITY linter slither-linter
...
class solidity_slither_linter_test(TestCase, LinterTestRoot):
    descriptor_id = "SOLIDITY"
    linter_name = "slither-linter"
