# !/usr/bin/env python3
"""
Unit tests for SALESFORCE linter code-analyzer-apexguru
...
class salesforce_code_analyzer_apexguru_test(TestCase, LinterTestRoot):
    descriptor_id = "SALESFORCE"
    linter_name = "code-analyzer-apexguru"
