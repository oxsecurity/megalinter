# !/usr/bin/env python3
"""
Unit tests for MARKDOWN linter markdown-table-prettify
...
class markdown_markdown_table_prettify_test(TestCase, LinterTestRoot):
    descriptor_id = "MARKDOWN"
    linter_name = "markdown-table-prettify"
