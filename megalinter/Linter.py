...
class Linter:
    ...
    def __init__(self, params=None, linter_config=None):
        ...
        self.sarif_errorformat_name = None
    ...
    def execute_lint_command(self, command):
        ...
        # Manage case when SARIF output is generated by errorformat from stdout
        if (
            self.can_output_sarif
            and self.output_sarif is True
            and self.sarif_errorformat_name is not None
        ):
            command = [
                "errorformat",
