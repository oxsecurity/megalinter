...
class Megalinter:
    ...
    def manage_upgrade_message(self):
        ...
        if "insiders" in mega_linter_version or "v4" in mega_linter_version or "v5" in mega_linter_version:
            logging.warning(
                c.yellow(
                    "#######################################################################"
                )
            ...
            logging.warning(
                c.yellow(
                    ...
                    "Please upgrade your configuration by running the following command at the root of your repo (requires node.js): \n"+
